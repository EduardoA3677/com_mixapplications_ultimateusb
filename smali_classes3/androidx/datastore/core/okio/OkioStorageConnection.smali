...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "onClose",
        "<init>",
        "(Lqf/o;Lqf/a0;Landroidx/datastore/core/okio/OkioSerializer;Landroidx/datastore/core/InterProcessCoordinator;Lkotlin/jvm/functions/Function0;)V",
        "checkNotClosed",
        "()V",
        "R",
        "Lkotlin/Function3;",
...
# direct methods
.method public constructor <init>(Lqf/o;Lqf/a0;Landroidx/datastore/core/okio/OkioSerializer;Landroidx/datastore/core/InterProcessCoordinator;Lkotlin/jvm/functions/Function0;)V
    .locals 1
    .param p1    # Lqf/o;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    iput-object p1, p0, Landroidx/datastore/core/okio/OkioStorageConnection;->fileSystem:Lqf/o;

    iput-object p2, p0, Landroidx/datastore/core/okio/OkioStorageConnection;->path:Lqf/a0;
...
.method public readScope(Lkotlin/jvm/functions/Function3;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-interface {p2, v4}, Lkotlinx/coroutines/sync/Mutex;->b(Ljava/lang/Object;)Z
    ...
    iget-object v5, p0, Landroidx/datastore/core/okio/OkioStorageConnection;->fileSystem:Lqf/o;

    iget-object v6, p0, Landroidx/datastore/core/okio/OkioStorageConnection;->path:Lqf/a0;
    ...
    invoke-direct {v2, v5, v6, v7}, Landroidx/datastore/core/okio/OkioReadScope;-><init>(Lqf/o;Lqf/a0;Landroidx/datastore/core/okio/OkioSerializer;)V
    :try_end_1
    ...
    invoke-interface {p1, v4}, Lkotlinx/coroutines/sync/Mutex;->d(Ljava/lang/Object;)V
    ...
    :try_start_6
    invoke-static {p2, v1}, Llf/l;->n(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public writeScope(Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object p2, p0, Landroidx/datastore/core/okio/OkioStorageConnection;->path:Lqf/a0;

    invoke-virtual {p2}, Lqf/a0;->c()Lqf/a0;

    move-result-object v3

    if-eqz v3, :cond_9

    iget-object p2, p0, Landroidx/datastore/core/okio/OkioStorageConnection;->fileSystem:Lqf/o;

    invoke-virtual {p2, v3}, Lqf/o;->c(Lqf/a0;)V
    ...
    invoke-interface {p2, v1}, Lkotlinx/coroutines/sync/Mutex;->a(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :goto_1
    :try_start_1
    iget-object v5, v7, Landroidx/datastore/core/okio/OkioStorageConnection;->path:Lqf/a0;

    invoke-virtual {v5}, Lqf/a0;->b()Ljava/lang/String;
    ...
    :try_start_2
    iget-object v3, v7, Landroidx/datastore/core/okio/OkioStorageConnection;->fileSystem:Lqf/o;

    invoke-virtual {v3, v0}, Lqf/o;->e(Lqf/a0;)V

    new-instance v3, Landroidx/datastore/core/okio/OkioWriteScope;

    iget-object v5, v7, Landroidx/datastore/core/okio/OkioStorageConnection;->fileSystem:Lqf/o;
    ...
    invoke-direct {v3, v5, v0, v8}, Landroidx/datastore/core/okio/OkioWriteScope;-><init>(Lqf/o;Lqf/a0;Landroidx/datastore/core/okio/OkioSerializer;)V
    :try_end_2
    ...
    :try_start_5
    iget-object p1, v1, Landroidx/datastore/core/okio/OkioStorageConnection;->fileSystem:Lqf/o;

    invoke-virtual {p1, v0}, Lqf/o;->g(Lqf/a0;)Z
    ...
    iget-object p2, v1, Landroidx/datastore/core/okio/OkioStorageConnection;->path:Lqf/a0;

    invoke-virtual {p1, v0, p2}, Lqf/o;->b(Lqf/a0;Lqf/a0;)V
    :try_end_5
    ...
    :goto_8
    :try_start_9
    iget-object v1, v7, Landroidx/datastore/core/okio/OkioStorageConnection;->fileSystem:Lqf/o;

    invoke-virtual {v1, v0}, Lqf/o;->g(Lqf/a0;)Z
    ...
    invoke-virtual {v1, v0}, Lqf/o;->e(Lqf/a0;)V
    :try_end_a
