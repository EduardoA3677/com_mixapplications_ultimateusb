...
.method private final performRemoveSpaceGesture(Landroidx/compose/foundation/text/LegacyTextFieldState;Landroid/view/inputmethod/RemoveSpaceGesture;Landroidx/compose/ui/text/AnnotatedString;Landroidx/compose/ui/platform/ViewConfiguration;Lkotlin/jvm/functions/Function1;)I
    ...
    invoke-direct {v3, v4}, Lde/i;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v4, p1, v2}, Landroidx/compose/foundation/text/input/internal/HandwritingGestureApi34$performRemoveSpaceGesture$newText$2;-><init>(Lkotlin/jvm/internal/j0;Lkotlin/jvm/internal/j0;)V

    invoke-virtual {v3, p3, v4}, Lde/i;->c(Ljava/lang/CharSequence;Lkotlin/jvm/functions/Function1;)Ljava/lang/String;
...
.method private final performRemoveSpaceGesture(Landroidx/compose/foundation/text/input/internal/TransformedTextFieldState;Landroid/view/inputmethod/RemoveSpaceGesture;Landroidx/compose/foundation/text/input/internal/TextLayoutState;Landroidx/compose/ui/platform/ViewConfiguration;)I
    ...
    iput v5, v4, Lkotlin/jvm/internal/j0;->a:I

    new-instance v6, Lkotlin/jvm/internal/j0;

    invoke-direct {v6}, Ljava/lang/Object;-><init>()V

    iput v5, v6, Lkotlin/jvm/internal/j0;->a:I
    ...
    invoke-direct {v8, v9}, Lde/i;-><init>(Ljava/lang/String;)V

    new-instance v9, Landroidx/compose/foundation/text/input/internal/HandwritingGestureApi34$performRemoveSpaceGesture$newText$1;

    invoke-direct {v9, v4, v6}, Landroidx/compose/foundation/text/input/internal/HandwritingGestureApi34$performRemoveSpaceGesture$newText$1;-><init>(Lkotlin/jvm/internal/j0;Lkotlin/jvm/internal/j0;)V

    invoke-virtual {v8, v7, v9}, Lde/i;->c(Ljava/lang/CharSequence;Lkotlin/jvm/functions/Function1;)Ljava/lang/String;

    move-result-object v7

    iget v8, v4, Lkotlin/jvm/internal/j0;->a:I

    if-eq v8, v5, :cond_2

    iget v8, v6, Lkotlin/jvm/internal/j0;->a:I
    ...
    iget v5, v4, Lkotlin/jvm/internal/j0;->a:I
    ...
    iget v3, v4, Lkotlin/jvm/internal/j0;->a:I
    ...
    iget v1, v6, Lkotlin/jvm/internal/j0;->a:I
...
.method public final performHandwritingGesture$foundation_release(Landroidx/compose/foundation/text/LegacyTextFieldState;Landroid/view/inputmethod/HandwritingGesture;Landroidx/compose/foundation/text/selection/TextFieldSelectionManager;Landroidx/compose/ui/platform/ViewConfiguration;Lkotlin/jvm/functions/Function1;)I
    ...
    :cond_2
    invoke-static {p2}, Landroidx/activity/m;->m(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_3

    invoke-static {p2}, Landroidx/activity/m;->g(Ljava/lang/Object;)Landroid/view/inputmethod/SelectGesture;
    ...
    :cond_3
    invoke-static {p2}, Landroidx/activity/m;->v(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_4

    invoke-static {p2}, Landroidx/activity/m;->c(Ljava/lang/Object;)Landroid/view/inputmethod/DeleteGesture;
    ...
    :cond_4
    invoke-static {p2}, Landroidx/activity/m;->w(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_5

    invoke-static {p2}, Landroidx/activity/m;->h(Ljava/lang/Object;)Landroid/view/inputmethod/SelectRangeGesture;
    ...
    :cond_5
    invoke-static {p2}, Landroidx/activity/m;->x(Ljava/lang/Object;)Z

    move-result p3

    if-eqz p3, :cond_6

    invoke-static {p2}, Landroidx/activity/m;->d(Ljava/lang/Object;)Landroid/view/inputmethod/DeleteRangeGesture;
    ...
    :cond_6
    invoke-static {p2}, Landroidx/activity/m;->s(Ljava/lang/Object;)Z

    move-result p3

    if-eqz p3, :cond_7

    invoke-static {p2}, Landroidx/activity/m;->e(Ljava/lang/Object;)Landroid/view/inputmethod/JoinOrSplitGesture;
    ...
    invoke-static {p2}, Landroidx/activity/m;->y(Ljava/lang/Object;)Z

    move-result p1

    if-eqz p1, :cond_8

    invoke-static {p2}, Landroidx/compose/foundation/text/input/internal/d;->d(Ljava/lang/Object;)Landroid/view/inputmethod/InsertGesture;
    ...
    :cond_8
    invoke-static {p2}, Landroidx/activity/m;->p(Ljava/lang/Object;)Z

    move-result p1

    if-eqz p1, :cond_9

    invoke-static {p2}, Landroidx/activity/m;->f(Ljava/lang/Object;)Landroid/view/inputmethod/RemoveSpaceGesture;
...
.method public final previewHandwritingGesture$foundation_release(Landroidx/compose/foundation/text/LegacyTextFieldState;Landroid/view/inputmethod/PreviewableHandwritingGesture;Landroidx/compose/foundation/text/selection/TextFieldSelectionManager;Landroid/os/CancellationSignal;)Z
    ...
    invoke-direct {p1, p3, p2}, Landroidx/compose/foundation/text/input/internal/e;-><init>(Ljava/lang/Object;I)V
...
.method public final previewHandwritingGesture$foundation_release(Landroidx/compose/foundation/text/input/internal/TransformedTextFieldState;Landroid/view/inputmethod/PreviewableHandwritingGesture;Landroidx/compose/foundation/text/input/internal/TextLayoutState;Landroid/os/CancellationSignal;)Z
    ...
    invoke-direct {p2, p1, p3}, Landroidx/compose/foundation/text/input/internal/e;-><init>(Ljava/lang/Object;I)V
