.class public Lcom/taurusx/tax/g/r0/z;
...
.method public static w(Landroid/net/Uri;)Landroid/content/Intent;
    ...
    sget-object v0, Lcom/taurusx/tax/g/r0/y;->HANDLE_SHARE_TWEET:Lcom/taurusx/tax/g/r0/y;

    invoke-virtual {v0, p0}, Lcom/taurusx/tax/g/r0/y;->shouldTryHandlingUrl(Landroid/net/Uri;)Z
    ...
    invoke-static {v1, v0, v2, p0}, Landroidx/constraintlayout/core/dsl/a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static w(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p0, p1}, Lcom/taurusx/tax/g/r0/z;->z(Landroid/content/Context;Landroid/content/Intent;)Z
    ...
    :cond_0
    invoke-static {p0, p1, v0}, Lcom/taurusx/tax/g/r0/z;->z(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lcom/taurusx/tax/g/r0/z;->z(Landroid/content/Intent;)Landroid/net/Uri;

    move-result-object p1

    invoke-static {p0, p1}, Lcom/taurusx/tax/g/r0/z;->z(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-static {p0, p1, v0}, Lcom/taurusx/tax/g/r0/z;->w(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)V
...
.method public static w(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-static {p0, p2, v0}, Lcom/taurusx/tax/g/r0/z;->z(Landroid/content/Context;Ljava/lang/Class;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    invoke-static {p0, p2, p1}, Lcom/taurusx/tax/g/r0/z;->z(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V
...
.method public static z(Landroid/net/Uri;)Landroid/content/Intent;
    ...
    sget-object v0, Lcom/taurusx/tax/g/r0/y;->OPEN_NATIVE_BROWSER:Lcom/taurusx/tax/g/r0/y;
...
.method public static z(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-static {p0, p1}, Lcom/taurusx/tax/g/r0/z;->y(Landroid/content/Context;Landroid/content/Intent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static z(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-static {p0, v0}, Lcom/taurusx/tax/g/r0/z;->z(Landroid/content/Context;Landroid/content/Intent;)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-static {p0, v0}, Lcom/taurusx/tax/g/r0/z;->w(Landroid/content/Context;Landroid/content/Intent;)V
...
.method public static z(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-static {p0, v0, p2}, Lcom/taurusx/tax/g/r0/z;->z(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;)V
