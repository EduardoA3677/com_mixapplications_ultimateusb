...
.method private static a(Landroid/content/Context;Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {p1}, Lcom/ironsource/y8;->a(Lorg/json/JSONObject;)Lcom/ironsource/F5;

    move-result-object p1

    invoke-virtual {p1}, Lcom/ironsource/F5;->a()Z
    ...
    invoke-static {p1, p0}, Lcom/ironsource/x8;->a(Lcom/ironsource/F5;Lcom/ironsource/v8;)V

    :cond_0
    return-void
.end method

.method public static declared-synchronized addInitListener(Lcom/ironsource/Jc;)V
    .locals 2
    ...
    invoke-interface {p0}, Lcom/ironsource/Jc;->onSuccess()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-virtual {v1}, Lcom/ironsource/Y9;->a()Lcom/ironsource/r8;

    move-result-object v1

    invoke-interface {p0, v1}, Lcom/ironsource/Jc;->onFail(Lcom/ironsource/r8;)V
    :try_end_2
...
.method public static declared-synchronized destroyAd(Lcom/ironsource/L9;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-interface {v1, p0}, Lcom/ironsource/X9;->b(Lcom/ironsource/L9;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized initSDK(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    :cond_0
    :try_start_1
    sget-object v2, Lcom/ironsource/sdk/IronSourceNetwork;->b:Lcom/ironsource/V9;
    ...
    invoke-virtual {v2, p3}, Lcom/ironsource/o4;->a(Ljava/lang/Throwable;)V
    ...
    :goto_0
    invoke-static {p0, p1, p2}, Lcom/ironsource/P9;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lcom/ironsource/V9;
...
.method public static declared-synchronized isAdAvailableForInstance(Lcom/ironsource/L9;)Z
    .locals 2
    ...
    :cond_0
    :try_start_1
    invoke-interface {v1, p0}, Lcom/ironsource/X9;->a(Lcom/ironsource/L9;)Z
...
.method public static declared-synchronized loadAd(Lcom/ironsource/L9;Ljava/util/Map;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v1, p0, p1}, Lcom/ironsource/X9;->a(Lcom/ironsource/L9;Ljava/util/Map;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized loadAdView(Landroid/app/Activity;Lcom/ironsource/L9;Ljava/util/Map;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v1, p0, p1, p2}, Lcom/ironsource/X9;->b(Landroid/app/Activity;Lcom/ironsource/L9;Ljava/util/Map;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static onPause(Landroid/app/Activity;)V
    ...
    :cond_0
    invoke-interface {v0, p0}, Lcom/ironsource/V9;->onPause(Landroid/app/Activity;)V
...
.method public static onResume(Landroid/app/Activity;)V
    ...
    :cond_0
    invoke-interface {v0, p0}, Lcom/ironsource/V9;->onResume(Landroid/app/Activity;)V
...
.method public static declared-synchronized release(Landroid/app/Activity;)V
    ...
    :cond_0
    :try_start_1
    invoke-interface {v1, p0}, Lcom/ironsource/V9;->a(Landroid/app/Activity;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public static declared-synchronized showAd(Landroid/app/Activity;Lcom/ironsource/L9;Ljava/util/Map;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v1, p0, p1, p2}, Lcom/ironsource/X9;->a(Landroid/app/Activity;Lcom/ironsource/L9;Ljava/util/Map;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static declared-synchronized updateInitFailed(Lcom/ironsource/r8;)V
    ...
    invoke-direct {v1, p0}, Lcom/ironsource/Y9;-><init>(Lcom/ironsource/r8;)V
    ...
    check-cast v2, Lcom/ironsource/Jc;

    invoke-interface {v2, p0}, Lcom/ironsource/Jc;->onFail(Lcom/ironsource/r8;)V
...
.method public static declared-synchronized updateInitSucceeded()V
    ...
    invoke-interface {v2}, Lcom/ironsource/Jc;->onSuccess()V
