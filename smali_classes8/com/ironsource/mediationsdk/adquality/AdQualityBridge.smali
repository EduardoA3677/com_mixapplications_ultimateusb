...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Lcom/ironsource/h0;I)V
    .locals 7
    ...
    invoke-virtual {p4}, Lcom/ironsource/h0;->a()Lorg/json/JSONObject;
    ...
    :cond_1
    sget-object v2, Lcom/ironsource/A5;->z:Lcom/ironsource/A5;
    ...
    invoke-static/range {v1 .. v6}, Lcom/ironsource/mediationsdk/adquality/AdQualityBridge$Companion;->logEvent$default(Lcom/ironsource/mediationsdk/adquality/AdQualityBridge$Companion;Lcom/ironsource/A5;Ljava/lang/Integer;Ljava/lang/String;ILjava/lang/Object;)V
...
.method private final getCoppaValue()Z
    ...
    invoke-virtual {v0, v1}, Lcom/ironsource/K6;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method private final getDeviceIdType()Lcom/ironsource/adqualitysdk/sdk/ISAdQualityDeviceIdType;
    ...
    invoke-virtual {v1, v2}, Lcom/ironsource/K6;->a(Ljava/lang/String;)Ljava/lang/String;
...
.method private static final logEvent(Lcom/ironsource/A5;Ljava/lang/Integer;Ljava/lang/String;)V
    .locals 1

    sget-object v0, Lcom/ironsource/mediationsdk/adquality/AdQualityBridge;->Companion:Lcom/ironsource/mediationsdk/adquality/AdQualityBridge$Companion;

    invoke-static {v0, p0, p1, p2}, Lcom/ironsource/mediationsdk/adquality/AdQualityBridge$Companion;->access$logEvent(Lcom/ironsource/mediationsdk/adquality/AdQualityBridge$Companion;Lcom/ironsource/A5;Ljava/lang/Integer;Ljava/lang/String;)V
...
.method public final setSegment(Lcom/ironsource/ba;)V
    .locals 5
    ...
    invoke-virtual {p1}, Lcom/ironsource/ba;->g()Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/ironsource/ba;->a()I
    ...
    :cond_1
    invoke-virtual {p1}, Lcom/ironsource/ba;->b()Ljava/lang/String;
    ...
    :cond_2
    invoke-virtual {p1}, Lcom/ironsource/ba;->e()I
    ...
    :cond_3
    invoke-virtual {p1}, Lcom/ironsource/ba;->d()Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_4
    invoke-virtual {p1}, Lcom/ironsource/ba;->c()D
    ...
    :cond_5
    invoke-virtual {p1}, Lcom/ironsource/ba;->h()J
    ...
    :cond_6
    invoke-virtual {p1}, Lcom/ironsource/ba;->f()Ljava/util/ArrayList;
    ...
    invoke-static {v2, v4, v3}, Lde/r;->c0(Ljava/lang/String;Ljava/lang/String;Z)Z

    move-result v3

    if-eqz v3, :cond_7

    invoke-static {v2, v4}, Lde/k;->y0(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
