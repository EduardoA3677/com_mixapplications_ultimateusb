...
.field private static dsaTransparencyData:Lorg/json/JSONObject; = null
...
.method private constructor <init>(Ljava/lang/String;Landroid/content/Context;)V
    ...
    const-string v0, "No WebView installed on device. APS SDK failed to initialize"
    ...
    invoke-static {}, Lcom/amazon/device/ads/DTBMetricsConfiguration;->getMetricsConfigOverride()Lcom/amazon/aps/shared/metrics/model/ApsMetricsConfigOverride;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-static {p1}, Lcom/amazon/aps/shared/ApsMetrics;->setMetricsConfigOverride(Lcom/amazon/aps/shared/metrics/model/ApsMetricsConfigOverride;)V
...
.method public static getInstance(Ljava/lang/String;Landroid/content/Context;)Lcom/amazon/device/ads/AdRegistration;
    ...
    invoke-virtual {p0}, Lcom/amazon/device/ads/DtbSharedPreferences;->getSDKBTemplate()Lorg/json/JSONObject;

    move-result-object p0

    invoke-static {p0}, Lcom/amazon/device/ads/DtbCommonUtils;->isNullOrEmpty(Lorg/json/JSONObject;)Z
...
.method public static initBidderSDK()V
    .locals 5
    ...
    invoke-virtual {v0}, Lcom/amazon/aps/bidder/adapter/ApsBidder;->getAllAdapterInstances()Ljava/util/Map;
    ...
    check-cast v1, Lcom/amazon/aps/bidder/adapter/ApsBidderAdapter;

    invoke-static {}, Lcom/amazon/device/ads/AdRegistration;->getContext()Landroid/content/Context;

    move-result-object v3

    new-instance v4, Lcom/amazon/device/ads/AdRegistration$1;

    invoke-direct {v4, v2, v1}, Lcom/amazon/device/ads/AdRegistration$1;-><init>(Ljava/lang/String;Lcom/amazon/aps/bidder/adapter/ApsBidderAdapter;)V

    invoke-virtual {v1, v3, v4}, Lcom/amazon/aps/bidder/adapter/ApsBidderAdapter;->initialize(Landroid/content/Context;Lcom/amazon/aps/bidder/listeners/ApsBidderSDKInitializationListener;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v3, "Failed to Initialize Bidder SDK"
