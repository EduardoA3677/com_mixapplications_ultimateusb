...
.method public constructor <init>(Lkotlin/reflect/jvm/internal/impl/load/java/structure/JavaClass;Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-static {p1, p2}, Lce/n;->W(Lce/k;Lkotlin/jvm/functions/Function1;)Lce/g;
...
.method public getFieldNames()Ljava/util/Set;
    ...
    invoke-direct {v2, v0}, Lce/f;-><init>(Lce/g;)V

    :goto_0
    invoke-virtual {v2}, Lce/f;->hasNext()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {v2}, Lce/f;->next()Ljava/lang/Object;
