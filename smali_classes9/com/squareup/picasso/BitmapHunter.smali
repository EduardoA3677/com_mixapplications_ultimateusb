...
.method public static decodeStream(Lqf/j0;Lcom/squareup/picasso/Request;)Landroid/graphics/Bitmap;
    .locals 6
    ...
    invoke-static {p0}, Ll0/wa;->r(Lqf/j0;)Lqf/d0;

    move-result-object p0

    invoke-static {p0}, Lcom/squareup/picasso/Utils;->isWebPFile(Lqf/j;)Z
    ...
    invoke-direct {v0, p0, v4}, Lcom/explorestack/protobuf/c7;-><init>(Ljava/lang/Object;I)V
    ...
    :cond_2
    invoke-virtual {p0}, Lqf/d0;->readByteArray()[B
...
.method public hunt()Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v1}, Lcom/squareup/picasso/RequestHandler$Result;->getSource()Lqf/j0;
    ...
    invoke-static {v0, v1}, Lcom/squareup/picasso/BitmapHunter;->decodeStream(Lqf/j0;Lcom/squareup/picasso/Request;)Landroid/graphics/Bitmap;
