...
.field public static final METRICS_CONFIG_KEY:Ljava/lang/String; = "metricsConfig"

.field private static final METRICS_CONFIG_OVERRIDE_PREF_KEY:Ljava/lang/String; = "aps_metrics_config_override"
...
.method public static clearMetricsConfigOverride()V
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/amazon/device/ads/DtbSharedPreferences;->removeMetricsConfigOverride()V

    const/4 v0, 0x0

    invoke-static {v0}, Lcom/amazon/aps/shared/ApsMetrics;->setMetricsConfigOverride(Lcom/amazon/aps/shared/metrics/model/ApsMetricsConfigOverride;)V
...
.method public static getClientConfigVal(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;D)Ljava/lang/Double;
    ...
    invoke-static {v2, p0, v3, p1, v3}, Landroidx/constraintlayout/core/dsl/a;->u(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public static getMetricsConfigOverride()Lcom/amazon/aps/shared/metrics/model/ApsMetricsConfigOverride;
    .locals 4
    ...
    invoke-virtual {v0}, Lcom/amazon/device/ads/DtbSharedPreferences;->getMetricsConfigOverride()Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/amazon/aps/shared/metrics/model/ApsMetricsConfigOverride;->fromJsonObject(Lorg/json/JSONObject;)Lcom/amazon/aps/shared/metrics/model/ApsMetricsConfigOverride;
    ...
    const-string v3, "Failed to retrieve metrics config override: "
...
.method public static processMetricsConfigFromResponse(Lorg/json/JSONObject;)V
    .locals 3

    const-string v0, "metricsConfig"
    ...
    invoke-static {p0}, Lcom/amazon/device/ads/DTBMetricsConfiguration;->saveMetricsConfigOverride(Lorg/json/JSONObject;)V

    sget-object p0, Lcom/amazon/device/ads/DTBMetricsConfiguration;->LOG_TAG:Ljava/lang/String;

    const-string v0, "Stored metrics config override from /getConfig response"

    invoke-static {p0, v0}, Lcom/amazon/device/ads/DtbLog;->info(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_0
    invoke-static {}, Lcom/amazon/device/ads/DTBMetricsConfiguration;->clearMetricsConfigOverride()V

    sget-object p0, Lcom/amazon/device/ads/DTBMetricsConfiguration;->LOG_TAG:Ljava/lang/String;

    const-string v0, "No metricsConfig in /getConfig response, cleared override"
    ...
    const-string v2, "Failed to process metrics config from response: "
    ...
    invoke-static {v0, p0}, Lcom/amazon/device/ads/DtbLog;->error(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public static saveMetricsConfigOverride(Lorg/json/JSONObject;)V
    .locals 3
    ...
    invoke-direct {v0, p0}, Lcom/amazon/aps/shared/metrics/model/ApsMetricsConfigOverride;-><init>(Lorg/json/JSONObject;)V

    invoke-static {}, Lcom/amazon/device/ads/DtbSharedPreferences;->getInstance()Lcom/amazon/device/ads/DtbSharedPreferences;

    move-result-object p0

    invoke-virtual {p0, v0}, Lcom/amazon/device/ads/DtbSharedPreferences;->saveMetricsConfigOverride(Lcom/amazon/aps/shared/metrics/model/ApsMetricsConfigOverride;)V
    ...
    const-string v2, "Failed to save metrics config override"
