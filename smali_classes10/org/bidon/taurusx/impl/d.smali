.class public final Lorg/bidon/taurusx/impl/d;
...
.field public c:Lcom/taurusx/tax/api/TaurusXBannerAds;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bidon/taurusx/impl/d;->a:Lorg/bidon/sdk/adapter/impl/AdEventFlowImpl;
    ...
    iput-object v0, p0, Lorg/bidon/taurusx/impl/d;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
...
.method public final addAuctionConfigurationId(J)V
    ...
    iget-object v0, p0, Lorg/bidon/taurusx/impl/d;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
...
.method public final destroy()V
    ...
    iget-object v0, p0, Lorg/bidon/taurusx/impl/d;->c:Lcom/taurusx/tax/api/TaurusXBannerAds;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/taurusx/tax/api/TaurusXBannerAds;->destroy()V

    :cond_0
    const/4 v0, 0x0

    iput-object v0, p0, Lorg/bidon/taurusx/impl/d;->c:Lcom/taurusx/tax/api/TaurusXBannerAds;
...
.method public final emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
    ...
    iget-object v0, p0, Lorg/bidon/taurusx/impl/d;->a:Lorg/bidon/sdk/adapter/impl/AdEventFlowImpl;
...
.method public final isAdReadyToShow()Z
    ...
    iget-boolean v0, p0, Lorg/bidon/taurusx/impl/d;->d:Z
...
.method public final load(Lorg/bidon/sdk/adapter/AdAuctionParams;)V
    ...
    check-cast p1, Lorg/bidon/taurusx/impl/b;

    const-string v0, "adParams"

    invoke-static {p1, v0}, Lkotlin/jvm/internal/p;->f(Ljava/lang/Object;Ljava/lang/String;)V

    iget-object v0, p1, Lorg/bidon/taurusx/impl/b;->b:Lorg/bidon/sdk/ads/banner/BannerFormat;

    sget-object v1, Lorg/bidon/taurusx/impl/a;->$EnumSwitchMapping$0:[I
    ...
    const-string v5, "Starting banner load with format: "
    ...
    const-string v4, "TaurusXBannerImpl"

    invoke-static {v4, v2}, Lorg/bidon/sdk/logs/logging/impl/LogExtKt;->logInfo(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, p1, Lorg/bidon/taurusx/impl/b;->e:Ljava/lang/String;

    iget-object v4, p0, Lorg/bidon/taurusx/impl/d;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
    ...
    invoke-virtual {v4}, Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;->getDemandId()Lorg/bidon/sdk/adapter/DemandId;
    ...
    invoke-virtual {p0, p1}, Lorg/bidon/taurusx/impl/d;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V

    return-void

    :cond_1
    iget-object v5, p1, Lorg/bidon/taurusx/impl/b;->c:Lorg/bidon/sdk/auction/models/AdUnit;

    invoke-virtual {v5}, Lorg/bidon/sdk/auction/models/AdUnit;->getBidType()Lorg/bidon/sdk/stats/models/BidType;

    move-result-object v5

    iget-object v6, p1, Lorg/bidon/taurusx/impl/b;->f:Ljava/lang/String;

    sget-object v7, Lorg/bidon/sdk/stats/models/BidType;->RTB:Lorg/bidon/sdk/stats/models/BidType;
    ...
    iget-object p1, p1, Lorg/bidon/taurusx/impl/b;->a:Landroid/app/Activity;

    invoke-direct {v4, p1}, Lcom/taurusx/tax/api/TaurusXBannerAds;-><init>(Landroid/app/Activity;)V

    iput-object v4, p0, Lorg/bidon/taurusx/impl/d;->c:Lcom/taurusx/tax/api/TaurusXBannerAds;

    invoke-virtual {v4, v2}, Lcom/taurusx/tax/api/TaurusXBannerAds;->setAdUnitId(Ljava/lang/String;)V
    ...
    :goto_1
    invoke-virtual {v4, p1}, Lcom/taurusx/tax/api/TaurusXBannerAds;->setAdSize(Lcom/taurusx/tax/core/AdSize;)V

    new-instance p1, Lorg/bidon/taurusx/impl/c;

    invoke-direct {p1, p0, v4}, Lorg/bidon/taurusx/impl/c;-><init>(Lorg/bidon/taurusx/impl/d;Lcom/taurusx/tax/api/TaurusXBannerAds;)V

    invoke-virtual {v4, p1}, Lcom/taurusx/tax/api/TaurusXBannerAds;->setListener(Lcom/taurusx/tax/api/OnTaurusXBannerListener;)V

    if-ne v5, v7, :cond_4

    invoke-virtual {v4, v6}, Lcom/taurusx/tax/api/TaurusXBannerAds;->loadBannerFromBid(Ljava/lang/String;)V

    return-void

    :cond_4
    invoke-virtual {v4}, Lcom/taurusx/tax/api/TaurusXBannerAds;->loadBanner()V
