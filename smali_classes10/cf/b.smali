...
.field public static final b:Lbf/x;

.field public static final c:Lbf/p0;

.field public static final d:Lqf/z;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcf/b;->a:[B

    new-array v2, v0, [Ljava/lang/String;

    invoke-static {v2}, Lcom/moloco/sdk/internal/publisher/f0;->C([Ljava/lang/String;)Lbf/x;

    move-result-object v2

    sput-object v2, Lcf/b;->b:Lbf/x;

    sget-object v2, Lbf/r0;->Companion:Lbf/q0;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const/4 v2, 0x0

    invoke-static {v1, v2}, Lbf/q0;->c([BLbf/c0;)Lbf/p0;

    move-result-object v3

    sput-object v3, Lcf/b;->c:Lbf/p0;

    sget-object v3, Lbf/l0;->Companion:Lbf/k0;

    const/4 v4, 0x7

    invoke-static {v3, v1, v2, v0, v4}, Lbf/k0;->d(Lbf/k0;[BLbf/c0;II)Lbf/j0;

    sget-object v1, Lqf/k;->d:Lqf/k;

    const-string v1, "efbbbf"

    invoke-static {v1}, Llf/n;->x(Ljava/lang/String;)Lqf/k;

    move-result-object v1

    const-string v2, "feff"

    invoke-static {v2}, Llf/n;->x(Ljava/lang/String;)Lqf/k;

    move-result-object v2

    const-string v3, "fffe"

    invoke-static {v3}, Llf/n;->x(Ljava/lang/String;)Lqf/k;

    move-result-object v3

    const-string v4, "0000ffff"

    invoke-static {v4}, Llf/n;->x(Ljava/lang/String;)Lqf/k;

    move-result-object v4

    const-string v5, "ffff0000"

    invoke-static {v5}, Llf/n;->x(Ljava/lang/String;)Lqf/k;

    move-result-object v5

    filled-new-array {v1, v2, v3, v4, v5}, [Lqf/k;
    ...
    invoke-static {v6}, Lhd/x;->q0(Ljava/util/List;)V
    ...
    invoke-static {v2}, Llf/l;->S([Ljava/lang/Object;)Ljava/util/ArrayList;
    ...
    invoke-static {v6, v4}, Llf/l;->s(Ljava/util/List;Ljava/lang/Comparable;)I
    ...
    invoke-virtual {v7, v0, v3, v8}, Lqf/k;->w(ILqf/k;I)Z
    ...
    :goto_4
    invoke-virtual {v4}, Lqf/h;->exhausted()Z
    ...
    invoke-virtual {v4}, Lqf/h;->readInt()I
    ...
    invoke-direct {v0, v1, v2}, Lqf/z;-><init>([Lqf/k;[I)V

    sput-object v0, Lcf/b;->d:Lqf/z;
    ...
    sput-object v0, Lcf/b;->e:Ljava/util/TimeZone;
    ...
    sput-object v0, Lcf/b;->f:Lde/i;

    const-class v0, Lbf/e0;
    ...
    invoke-static {v0, v1}, Lde/k;->y0(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object v0, Lcf/b;->g:Ljava/lang/String;
...
.method public static final a(Lbf/z;Lbf/z;)Z
    .locals 2
    ...
    iget-object v0, p0, Lbf/z;->d:Ljava/lang/String;

    iget-object v1, p1, Lbf/z;->d:Ljava/lang/String;
    ...
    iget v0, p0, Lbf/z;->e:I

    iget v1, p1, Lbf/z;->e:I

    if-ne v0, v1, :cond_0

    iget-object p0, p0, Lbf/z;->a:Ljava/lang/String;

    iget-object p1, p1, Lbf/z;->a:Ljava/lang/String;
...
.method public static final h([Ljava/lang/String;[Ljava/lang/String;Ljava/util/Comparator;)Z
    ...
    :cond_2
    invoke-virtual {v4}, Lgd/r;->hasNext()Z

    move-result v5

    if-eqz v5, :cond_3

    invoke-virtual {v4}, Lgd/r;->next()Ljava/lang/Object;
...
.method public static final i(Lbf/n0;)J
    .locals 2
...
.method public static final q(Lqf/j;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
    .locals 1
    ...
    sget-object v0, Lcf/b;->d:Lqf/z;

    invoke-interface {p0, v0}, Lqf/j;->f(Lqf/z;)I
    ...
    sget-object p0, Lde/a;->g:Ljava/nio/charset/Charset;
    ...
    sput-object p0, Lde/a;->g:Ljava/nio/charset/Charset;
    ...
    sget-object p0, Lde/a;->h:Ljava/nio/charset/Charset;
    ...
    sput-object p0, Lde/a;->h:Ljava/nio/charset/Charset;
...
.method public static final r(Lqf/j;)I
    .locals 2
    ...
    invoke-interface {p0}, Lqf/j;->readByte()B
...
.method public static final s(Lqf/j0;I)Z
    .locals 12
    ...
    invoke-interface {p0}, Lqf/j0;->timeout()Lqf/l0;

    move-result-object v3

    invoke-virtual {v3}, Lqf/l0;->e()Z
    ...
    invoke-virtual {v3, v8, v9}, Lqf/l0;->d(J)Lqf/l0;
    ...
    invoke-interface {p0, p1, v8, v9}, Lqf/j0;->read(Lqf/h;J)J
    ...
    iget-wide v8, p1, Lqf/h;->b:J

    invoke-virtual {p1, v8, v9}, Lqf/h;->skip(J)V
    :try_end_0
    ...
    invoke-virtual {p0}, Lqf/l0;->a()Lqf/l0;
    ...
    invoke-virtual {p0, v1, v2}, Lqf/l0;->d(J)Lqf/l0;
...
.method public static final t(Ljava/util/List;)Lbf/x;
    .locals 3
    ...
    iget-object v2, v1, Ljf/b;->a:Lqf/k;

    iget-object v1, v1, Ljf/b;->b:Lqf/k;
...
.method public static final u(Lbf/z;Z)Ljava/lang/String;
    .locals 4
    ...
    iget-object v1, p0, Lbf/z;->d:Ljava/lang/String;
...
.method public static final v(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p0}, Lhd/t;->C1(Ljava/util/Collection;)Ljava/util/ArrayList;
...
.method public static final x(Ljava/lang/String;II)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2}, Lcf/b;->l(Ljava/lang/String;II)I

    move-result p1

    invoke-static {p0, p1, p2}, Lcf/b;->m(Ljava/lang/String;II)I
