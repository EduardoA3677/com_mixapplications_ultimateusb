.class public final Lorg/bidon/bigoads/impl/j;
...
.field public c:Lsg/bigo/ads/api/InterstitialAd;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bidon/bigoads/impl/j;->a:Lorg/bidon/sdk/adapter/impl/AdEventFlowImpl;
    ...
    iput-object v0, p0, Lorg/bidon/bigoads/impl/j;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
...
.method public final addAuctionConfigurationId(J)V
    ...
    iget-object v0, p0, Lorg/bidon/bigoads/impl/j;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
...
.method public final destroy()V
    ...
    iget-object v0, p0, Lorg/bidon/bigoads/impl/j;->c:Lsg/bigo/ads/api/InterstitialAd;
    ...
    iput-object v0, p0, Lorg/bidon/bigoads/impl/j;->c:Lsg/bigo/ads/api/InterstitialAd;
...
.method public final emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
    ...
    iget-object v0, p0, Lorg/bidon/bigoads/impl/j;->a:Lorg/bidon/sdk/adapter/impl/AdEventFlowImpl;
...
.method public final load(Lorg/bidon/sdk/adapter/AdAuctionParams;)V
    ...
    check-cast p1, Lorg/bidon/bigoads/impl/g;

    const-string v0, "adParams"

    invoke-static {p1, v0}, Lkotlin/jvm/internal/p;->f(Ljava/lang/Object;Ljava/lang/String;)V

    iget-object v0, p1, Lorg/bidon/bigoads/impl/g;->c:Ljava/lang/String;

    iget-object v1, p0, Lorg/bidon/bigoads/impl/j;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
    ...
    invoke-virtual {p0, p1}, Lorg/bidon/bigoads/impl/j;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V

    return-void

    :cond_0
    new-instance v2, Lsg/bigo/ads/api/InterstitialAdLoader$Builder;

    invoke-direct {v2}, Lsg/bigo/ads/api/InterstitialAdLoader$Builder;-><init>()V

    new-instance v3, Lorg/bidon/bigoads/impl/i;

    invoke-direct {v3, p0, p1}, Lorg/bidon/bigoads/impl/i;-><init>(Lorg/bidon/bigoads/impl/j;Lorg/bidon/bigoads/impl/g;)V

    invoke-virtual {v2, v3}, Lsg/bigo/ads/api/InterstitialAdLoader$Builder;->withAdLoadListener(Lsg/bigo/ads/api/AdLoadListener;)Lsg/bigo/ads/api/InterstitialAdLoader$Builder;

    move-result-object v2

    invoke-virtual {v2}, Lsg/bigo/ads/api/InterstitialAdLoader$Builder;->build()Lsg/bigo/ads/api/InterstitialAdLoader;
    ...
    new-instance v3, Lsg/bigo/ads/api/InterstitialAdRequest$Builder;

    invoke-direct {v3}, Lsg/bigo/ads/api/InterstitialAdRequest$Builder;-><init>()V

    iget-object v4, p1, Lorg/bidon/bigoads/impl/g;->a:Lorg/bidon/sdk/auction/models/AdUnit;
    ...
    iget-object p1, p1, Lorg/bidon/bigoads/impl/g;->d:Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {v3, p1}, Lsg/bigo/ads/api/c;->withBid(Ljava/lang/String;)Lsg/bigo/ads/api/c;

    :cond_2
    invoke-virtual {v3, v0}, Lsg/bigo/ads/api/c;->withSlotId(Ljava/lang/String;)Lsg/bigo/ads/api/c;

    invoke-virtual {v3}, Lsg/bigo/ads/api/c;->build()Lsg/bigo/ads/api/b;

    move-result-object p1

    invoke-virtual {v2, p1}, Lsg/bigo/ads/controller/loader/AbstractAdLoader;->loadAd(Lsg/bigo/ads/api/b;)V
...
.method public final show(Landroid/app/Activity;)V
    ...
    iget-object p1, p0, Lorg/bidon/bigoads/impl/j;->c:Lsg/bigo/ads/api/InterstitialAd;
