...
.field private static b:Lcom/ironsource/kf; = null
...
.method private static a(Landroid/content/Context;)V
    ...
    sget-object v0, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/kf;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/ironsource/kf;->b()Z
    ...
    invoke-virtual {v0}, Lcom/ironsource/kf;->c()Z
...
.method private static a()Z
    ...
    invoke-virtual {v0}, Lcom/ironsource/kf;->a()Z
...
.method private static b(Landroid/content/Context;)Ljava/io/File;
    ...
    sget-object v1, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/kf;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lcom/ironsource/kf;->d()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-interface {v0, p0}, Lcom/ironsource/y7;->l(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lcom/ironsource/y7;->f(Landroid/content/Context;)Ljava/io/File;
...
.method private static b(Ljava/io/File;)Ljava/io/File;
    ...
    invoke-static {v1, p0, v2, p0}, Landroidx/constraintlayout/core/dsl/a;->r(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static buildAbsolutePathToDirInCache(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, p1}, Lab/a;->q(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static buildFilesMapOfDirectory(Lcom/ironsource/z8;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    .locals 6
    ...
    invoke-direct {v4, v3}, Lcom/ironsource/z8;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v4, p1}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->buildFilesMapOfDirectory(Lcom/ironsource/z8;Lorg/json/JSONObject;)Lorg/json/JSONObject;
...
.method private static c(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-interface {v0, p0}, Lcom/ironsource/y7;->B(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lcom/ironsource/y7;->j(Landroid/content/Context;)Ljava/io/File;
...
.method public static declared-synchronized deleteFile(Lcom/ironsource/z8;)Z
    .locals 2
...
.method public static ensurePathSafety(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/ironsource/kf;->e()Z
...
.method public static getFilesInFolderRecursive(Lcom/ironsource/z8;)Ljava/util/ArrayList;
    .locals 5
    ...
    invoke-static {v4}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->getFilesInFolderRecursive(Lcom/ironsource/z8;)Ljava/util/ArrayList;
...
.method public static getTotalSizeOfDir(Lcom/ironsource/z8;)J
    .locals 6
    ...
    invoke-direct {v5, v4}, Lcom/ironsource/z8;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v5}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->getTotalSizeOfDir(Lcom/ironsource/z8;)J
...
.method public static initializeCacheDirectory(Landroid/content/Context;Lcom/ironsource/kf;)V
    .locals 0
    ...
    sput-object p1, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/kf;
...
.method public static readFile(Lcom/ironsource/z8;)Ljava/lang/String;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
