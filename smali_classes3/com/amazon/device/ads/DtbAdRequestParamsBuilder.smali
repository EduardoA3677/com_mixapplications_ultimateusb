...
# static fields
.field static final bidderParamFormat:Ljava/lang/String; = "{\"user\":{\"buyeruid\":\"%s\"}, \"imp\":[{\"displaymanager\":\"%s\",\"displaymanagerver\":\"%s\"}]}"
...
.method private getValidSignal(Lcom/amazon/aps/bidder/adapter/ApsBidderAdapter;)Ljava/lang/String;
    .locals 3
    ...
    const-string v2, "User Consent not granted"

    invoke-static {v0, v2}, Lcom/amazon/aps/ads/ApsLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string p1, "_TOKEN_P1_CONSENT"
    ...
    const-string v0, "NoConsent"

    const/4 v2, 0x0

    invoke-static {p1, v0, v2}, Lcom/amazon/aps/shared/ApsMetrics;->customEvent(Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONObject;)V
...
.method public getBidderParams()Ljava/util/HashMap;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v1}, Lcom/amazon/aps/bidder/adapter/ApsBidder;->getAllAdapterInstances()Ljava/util/Map;
    ...
    const-string v2, "No Bidder Adapter found"

    invoke-static {v1, v2}, Lcom/amazon/aps/ads/ApsLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v3}, Lcom/amazon/device/ads/DtbAdRequestParamsBuilder;->getValidSignal(Lcom/amazon/aps/bidder/adapter/ApsBidderAdapter;)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v3}, Lcom/amazon/aps/bidder/adapter/ApsBidderAdapter;->getSignal()Ljava/util/Map;

    move-result-object v6

    const-string v7, "bidderName"
    ...
    invoke-virtual {v3}, Lcom/amazon/aps/bidder/adapter/ApsBidderAdapter;->getBidderSDKVersion()Ljava/lang/String;
    ...
    const-string/jumbo v8, "{\"user\":{\"buyeruid\":\""

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v7, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v5, "\"}, \"imp\":[{\"displaymanager\":\""

    invoke-virtual {v7, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v7, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v5, "\",\"displaymanagerver\":\""
    ...
    const-string v4, "SDKB : Error during token collection from bidder Adapter"
...
.method public getParams(Landroid/content/Context;Ljava/util/List;Ljava/util/Map;Z)Ljava/util/HashMap;
    ...
    invoke-virtual {p0}, Lcom/amazon/device/ads/DtbAdRequestParamsBuilder;->getBidderParams()Ljava/util/HashMap;
