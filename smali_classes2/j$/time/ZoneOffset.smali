...
.method public static F(Ljava/lang/String;)Lj$/time/ZoneOffset;
    .locals 7
    ...
    sget-object v0, Lj$/time/ZoneOffset;->d:Ljava/util/concurrent/ConcurrentMap;
    ...
    invoke-static {p0, v2, v3}, Lj$/time/ZoneOffset;->I(Ljava/lang/CharSequence;IZ)I

    move-result v0

    invoke-static {p0, v6, v2}, Lj$/time/ZoneOffset;->I(Ljava/lang/CharSequence;IZ)I

    move-result v1

    invoke-static {p0, v5, v2}, Lj$/time/ZoneOffset;->I(Ljava/lang/CharSequence;IZ)I
    ...
    invoke-static {p0, v1, v3}, Lj$/time/ZoneOffset;->I(Ljava/lang/CharSequence;IZ)I

    move-result v1

    invoke-static {p0, v4, v3}, Lj$/time/ZoneOffset;->I(Ljava/lang/CharSequence;IZ)I
    ...
    invoke-static {p0, v0, v1}, Lj$/time/ZoneOffset;->G(III)Lj$/time/ZoneOffset;
    ...
    :cond_9
    invoke-static {v0, v1, v2}, Lj$/time/ZoneOffset;->G(III)Lj$/time/ZoneOffset;
...
.method public static G(III)Lj$/time/ZoneOffset;
    .locals 4
...
.method public static H(I)Lj$/time/ZoneOffset;
    ...
    sget-object v1, Lj$/time/ZoneOffset;->c:Ljava/util/concurrent/ConcurrentMap;
...
.method public static I(Ljava/lang/CharSequence;IZ)I
    .locals 2
...
.method public static J(Ljava/io/DataInput;)Lj$/time/ZoneOffset;
    .locals 2
...
.method public final E(Ljava/io/DataOutput;)V
    ...
    invoke-virtual {p0, p1}, Lj$/time/ZoneOffset;->K(Ljava/io/DataOutput;)V
...
.method public final d(Lj$/time/temporal/q;)I
    ...
    invoke-virtual {p0, p1}, Lj$/time/ZoneOffset;->f(Lj$/time/temporal/q;)J
...
.method public final q()Lj$/time/zone/f;
    .locals 1
