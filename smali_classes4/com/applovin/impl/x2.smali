...
.field private f:Lcom/applovin/impl/x2$a;


# direct methods
.method public constructor <init>(Lcom/applovin/mediation/nativeAds/adPlacer/MaxAdPlacerSettings;Landroid/content/Context;Lcom/applovin/impl/x2$a;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/applovin/impl/x2;->c:Ljava/util/Queue;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/applovin/impl/x2;->d:Z

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lcom/applovin/impl/x2;->e:Ljava/lang/Object;

    invoke-virtual {p1}, Lcom/applovin/mediation/nativeAds/adPlacer/MaxAdPlacerSettings;->getMaxPreloadedAdCount()I

    move-result v0

    iput v0, p0, Lcom/applovin/impl/x2;->a:I

    iput-object p3, p0, Lcom/applovin/impl/x2;->f:Lcom/applovin/impl/x2$a;
    ...
    iput-object p3, p0, Lcom/applovin/impl/x2;->b:Lcom/applovin/mediation/nativeAds/MaxNativeAdLoader;
...
.method public a()V
    ...
    iget-object v0, p0, Lcom/applovin/impl/x2;->e:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/applovin/impl/x2;->c:Ljava/util/Queue;
    ...
    invoke-virtual {p0, v2}, Lcom/applovin/impl/x2;->a(Lcom/applovin/mediation/MaxAd;)V
...
.method public a(Lcom/applovin/mediation/MaxAd;)V
    ...
    iget-object v0, p0, Lcom/applovin/impl/x2;->b:Lcom/applovin/mediation/nativeAds/MaxNativeAdLoader;
...
.method public b()Lcom/applovin/mediation/MaxAd;
    ...
    :goto_0
    :try_start_0
    iget-object v2, p0, Lcom/applovin/impl/x2;->c:Ljava/util/Queue;
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/applovin/impl/x2;->e()V
...
.method public c()V
    ...
    iput-object v0, p0, Lcom/applovin/impl/x2;->f:Lcom/applovin/impl/x2$a;

    invoke-virtual {p0}, Lcom/applovin/impl/x2;->a()V
...
.method public e()V
    ...
    :try_start_0
    iget-boolean v1, p0, Lcom/applovin/impl/x2;->d:Z
    ...
    iget v2, p0, Lcom/applovin/impl/x2;->a:I

    if-ge v1, v2, :cond_0

    const/4 v1, 0x1

    iput-boolean v1, p0, Lcom/applovin/impl/x2;->d:Z

    iget-object v1, p0, Lcom/applovin/impl/x2;->b:Lcom/applovin/mediation/nativeAds/MaxNativeAdLoader;
...
.method public onAdRevenuePaid(Lcom/applovin/mediation/MaxAd;)V
    ...
    iget-object v0, p0, Lcom/applovin/impl/x2;->f:Lcom/applovin/impl/x2$a;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, Lcom/applovin/impl/x2$a;->onAdRevenuePaid(Lcom/applovin/mediation/MaxAd;)V
...
.method public onNativeAdClicked(Lcom/applovin/mediation/MaxAd;)V
    ...
    invoke-interface {v0, p1}, Lcom/applovin/impl/x2$a;->onNativeAdClicked(Lcom/applovin/mediation/MaxAd;)V
...
.method public onNativeAdLoadFailed(Ljava/lang/String;Lcom/applovin/mediation/MaxError;)V
    ...
    invoke-interface {v0, p1, p2}, Lcom/applovin/impl/x2$a;->onNativeAdLoadFailed(Ljava/lang/String;Lcom/applovin/mediation/MaxError;)V
...
.method public onNativeAdLoaded(Lcom/applovin/mediation/nativeAds/MaxNativeAdView;Lcom/applovin/mediation/MaxAd;)V
    ...
    iget-object p1, p0, Lcom/applovin/impl/x2;->e:Ljava/lang/Object;

    monitor-enter p1

    :try_start_0
    iget-object v0, p0, Lcom/applovin/impl/x2;->c:Ljava/util/Queue;

    invoke-interface {v0, p2}, Ljava/util/Queue;->add(Ljava/lang/Object;)Z

    const/4 p2, 0x0

    iput-boolean p2, p0, Lcom/applovin/impl/x2;->d:Z
    ...
    iget-object p1, p0, Lcom/applovin/impl/x2;->f:Lcom/applovin/impl/x2$a;

    if-eqz p1, :cond_0

    invoke-interface {p1}, Lcom/applovin/impl/x2$a;->onNativeAdLoaded()V
