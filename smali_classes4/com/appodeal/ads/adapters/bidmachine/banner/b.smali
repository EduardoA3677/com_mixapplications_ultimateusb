.class public final Lcom/appodeal/ads/adapters/bidmachine/banner/b;
...
.method public final load(Lcom/appodeal/ads/modules/common/internal/context/ContextProvider;Lcom/appodeal/ads/unified/UnifiedAdParams;Lcom/appodeal/ads/AdUnitParams;Lcom/appodeal/ads/unified/UnifiedAdCallback;)V
    ...
    sget-object p2, Lm6/g;->e:Lm6/g;

    goto :goto_0

    :cond_0
    sget-object p2, Lm6/g;->c:Lm6/g;
    ...
    invoke-virtual {v0, v1}, Lio/bidmachine/AdRequest$AdRequestBuilderImpl;->setPriceFloorParams(Lio/bidmachine/PriceFloorParams;)Lv9/f;

    iget-object v1, p3, Lcom/appodeal/ads/adapters/bidmachine/f;->c:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lio/bidmachine/AdRequest$AdRequestBuilderImpl;->setNetworks(Ljava/lang/String;)Lv9/f;

    iget-object p3, p3, Lcom/appodeal/ads/adapters/bidmachine/f;->b:Lio/bidmachine/CustomParams;

    invoke-virtual {v0, p3}, Lio/bidmachine/AdRequest$AdRequestBuilderImpl;->setCustomParams(Lio/bidmachine/CustomParams;)Lv9/f;

    invoke-virtual {v0, p2}, Lm6/e;->a(Lm6/g;)V
    ...
    iput-object p3, p0, Lcom/appodeal/ads/adapters/bidmachine/banner/b;->b:Lm6/f;

    new-instance p3, Lm6/h;

    invoke-direct {p3, p1}, Lio/bidmachine/AdView;-><init>(Landroid/content/Context;)V

    iput-object p3, p0, Lcom/appodeal/ads/adapters/bidmachine/banner/b;->a:Lm6/h;

    new-instance p1, Lcom/appodeal/ads/adapters/bidmachine/banner/a;

    invoke-direct {p1, p4, p2}, Lcom/appodeal/ads/adapters/bidmachine/banner/a;-><init>(Lcom/appodeal/ads/unified/UnifiedBannerCallback;Lm6/g;)V

    invoke-virtual {p3, p1}, Lio/bidmachine/AdView;->setListener(Lio/bidmachine/AdListener;)Lio/bidmachine/AdView;

    iget-object p1, p0, Lcom/appodeal/ads/adapters/bidmachine/banner/b;->a:Lm6/h;

    iget-object p2, p0, Lcom/appodeal/ads/adapters/bidmachine/banner/b;->b:Lm6/f;
...
.method public final onDestroy()V
    ...
    iget-object v0, p0, Lcom/appodeal/ads/adapters/bidmachine/banner/b;->b:Lm6/f;
    ...
    iput-object v1, p0, Lcom/appodeal/ads/adapters/bidmachine/banner/b;->b:Lm6/f;

    :cond_0
    iget-object v0, p0, Lcom/appodeal/ads/adapters/bidmachine/banner/b;->a:Lm6/h;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lio/bidmachine/AdView;->destroy()V

    iput-object v1, p0, Lcom/appodeal/ads/adapters/bidmachine/banner/b;->a:Lm6/h;
