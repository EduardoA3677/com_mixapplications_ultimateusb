...
.method private final dfs(Ljava/util/List;Ljava/util/List;ILkotlin/jvm/functions/Function1;)V
    ...
    invoke-static {p2}, Lhd/y;->D0(Ljava/util/List;)Ljava/lang/Object;
...
.method public static final resolve([Ljava/lang/String;[[Ljava/lang/String;)[[I
    ...
    invoke-static {v8, v6, v7, v8, v5}, Landroidx/media3/common/util/a;->n(Ljava/util/Locale;Ljava/lang/String;Ljava/lang/String;Ljava/util/Locale;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v11, v6, v10, v11, v5}, Landroidx/media3/common/util/a;->n(Ljava/util/Locale;Ljava/lang/String;Ljava/lang/String;Ljava/util/Locale;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v6}, Lhd/y;->u0(Ljava/util/Collection;[Ljava/lang/Object;)V
    ...
    :cond_4
    invoke-static {v2}, Lxd/a;->n(Lid/j;)Lid/j;
    ...
    iget-object v10, v2, Lid/j;->a:Lid/g;

    invoke-virtual {v10, v8}, Lid/g;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v4, v10}, Lid/d;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, v3}, Lid/d;->listIterator(I)Ljava/util/ListIterator;
    ...
    check-cast v15, Lid/c;

    invoke-virtual {v15}, Lid/c;->hasNext()Z

    move-result v16

    if-eqz v16, :cond_9

    invoke-virtual {v15}, Lid/c;->next()Ljava/lang/Object;
    ...
    invoke-virtual {v13, v3}, Lid/d;->add(Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-static {v13}, Llf/l;->u(Ljava/util/List;)Lid/d;

    move-result-object v3

    invoke-virtual {v3}, Lid/d;->isEmpty()Z
    ...
    invoke-static {v0, v12, v1}, Lab/a;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lhd/t;->A1(Ljava/util/Collection;)[I
