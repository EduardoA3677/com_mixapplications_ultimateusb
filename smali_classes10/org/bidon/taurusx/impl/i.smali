.class public final Lorg/bidon/taurusx/impl/i;
...
.field public c:Lcom/taurusx/tax/api/TaurusXRewardedAds;

.field public final d:Lorg/bidon/taurusx/impl/h;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bidon/taurusx/impl/i;->a:Lorg/bidon/sdk/adapter/impl/AdEventFlowImpl;
    ...
    iput-object v0, p0, Lorg/bidon/taurusx/impl/i;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;

    new-instance v0, Lorg/bidon/taurusx/impl/h;

    invoke-direct {v0, p0}, Lorg/bidon/taurusx/impl/h;-><init>(Lorg/bidon/taurusx/impl/i;)V

    iput-object v0, p0, Lorg/bidon/taurusx/impl/i;->d:Lorg/bidon/taurusx/impl/h;
...
.method public final addAuctionConfigurationId(J)V
    ...
    iget-object v0, p0, Lorg/bidon/taurusx/impl/i;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
...
.method public final destroy()V
    ...
    iget-object v0, p0, Lorg/bidon/taurusx/impl/i;->c:Lcom/taurusx/tax/api/TaurusXRewardedAds;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    invoke-virtual {v0, v1}, Lcom/taurusx/tax/api/TaurusXRewardedAds;->setListener(Lcom/taurusx/tax/api/OnTaurusXRewardListener;)V

    :cond_0
    iput-object v1, p0, Lorg/bidon/taurusx/impl/i;->c:Lcom/taurusx/tax/api/TaurusXRewardedAds;
...
.method public final emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
    ...
    iget-object v0, p0, Lorg/bidon/taurusx/impl/i;->a:Lorg/bidon/sdk/adapter/impl/AdEventFlowImpl;
...
.method public final isAdReadyToShow()Z
    ...
    invoke-virtual {v0}, Lcom/taurusx/tax/api/TaurusXRewardedAds;->isReady()Z
...
.method public final load(Lorg/bidon/sdk/adapter/AdAuctionParams;)V
    ...
    const-string v1, "Starting Rewarded load"
    ...
    iget-object v1, p0, Lorg/bidon/taurusx/impl/i;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
    ...
    invoke-virtual {p0, p1}, Lorg/bidon/taurusx/impl/i;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
    ...
    :cond_1
    new-instance v1, Lcom/taurusx/tax/api/TaurusXRewardedAds;

    iget-object p1, p1, Lorg/bidon/taurusx/impl/e;->a:Landroid/content/Context;

    invoke-direct {v1, p1}, Lcom/taurusx/tax/api/TaurusXRewardedAds;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lorg/bidon/taurusx/impl/i;->c:Lcom/taurusx/tax/api/TaurusXRewardedAds;

    invoke-virtual {v1, v0}, Lcom/taurusx/tax/api/TaurusXRewardedAds;->setAdUnitId(Ljava/lang/String;)V

    iget-object p1, p0, Lorg/bidon/taurusx/impl/i;->d:Lorg/bidon/taurusx/impl/h;

    invoke-virtual {v1, p1}, Lcom/taurusx/tax/api/TaurusXRewardedAds;->setListener(Lcom/taurusx/tax/api/OnTaurusXRewardListener;)V

    if-ne v2, v4, :cond_2

    invoke-virtual {v1, v3}, Lcom/taurusx/tax/api/TaurusXRewardedAds;->loadRewardFromBid(Ljava/lang/String;)V

    return-void

    :cond_2
    invoke-virtual {v1}, Lcom/taurusx/tax/api/TaurusXRewardedAds;->loadReward()V
...
.method public final show(Landroid/app/Activity;)V
    ...
    invoke-virtual {p0}, Lorg/bidon/taurusx/impl/i;->isAdReadyToShow()Z

    move-result p1

    if-eqz p1, :cond_1

    iget-object p1, p0, Lorg/bidon/taurusx/impl/i;->c:Lcom/taurusx/tax/api/TaurusXRewardedAds;
