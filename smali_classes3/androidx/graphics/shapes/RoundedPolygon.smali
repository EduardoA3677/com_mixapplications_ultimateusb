...
.method public constructor <init>(Ljava/util/List;FF)V
    ...
    invoke-virtual {v2, v8}, Lid/d;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v2, v1}, Lid/d;->add(Ljava/lang/Object;)Z

    :cond_b
    invoke-static {v2}, Llf/l;->u(Ljava/util/List;)Lid/d;
    ...
    invoke-virtual {v1, v2}, Lid/d;->get(I)Ljava/lang/Object;
...
.method public final transformed(Landroidx/graphics/shapes/PointTransformer;)Landroidx/graphics/shapes/RoundedPolygon;
    ...
    invoke-virtual {v2, v5}, Lid/d;->add(Ljava/lang/Object;)Z
