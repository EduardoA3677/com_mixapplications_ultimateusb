...
.method public final getEidsAsHttpQueryParams()Ljava/util/Map;
    ...
    invoke-virtual {v2}, Lcom/mobilefuse/sdk/identity/EidRequestProcessor;->shouldApplyCoppaRestrictions()Z
    ...
    :cond_0
    iget-object v2, p0, Lcom/mobilefuse/sdk/identity/EidService;->eidsOutputTransformer:Lcom/mobilefuse/sdk/identity/EidsOutputTransformer;
    ...
    iget-object v3, p0, Lcom/mobilefuse/sdk/identity/EidService;->eidData:Lcom/mobilefuse/sdk/identity/EidSdkData;

    invoke-virtual {v3}, Lcom/mobilefuse/sdk/identity/EidSdkData;->getSdkEids()Ljava/util/Map;
    ...
    :cond_1
    sget-object v3, Lcom/mobilefuse/sdk/identity/EidService;->Companion:Lcom/mobilefuse/sdk/identity/EidService$Companion;

    const-string v4, "(-) EID managed mode is disabled, use only overridden EID identifiers"

    invoke-virtual {v3, v4}, Lcom/mobilefuse/sdk/identity/EidService$Companion;->log$mobilefuse_sdk_core_release(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v4}, Lcom/mobilefuse/sdk/identity/EidsOutputTransformer;->uriEncodeForBidRequest$mobilefuse_sdk_core_release(Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
    ...
    :goto_2
    sget-object v3, Lcom/mobilefuse/sdk/identity/EidService$getEidsAsHttpQueryParams$$inlined$gracefullyHandleException$1$wm$TryKt$WhenMappings;->$EnumSwitchMapping$1:[I
...
.method public final handleSdkStateChanged(Lcom/mobilefuse/sdk/identity/IdentifierUpdateSignal;)V
    ...
    invoke-static {p1}, Lxd/a;->R(Ljava/lang/Object;)Ljava/util/Set;
...
.method public final handleSdkStateChanged(Ljava/util/Set;)V
    ...
    const-string v0, "(+) Received request to refresh EIDs with signals: "
    ...
    invoke-virtual {v2, v0}, Lcom/mobilefuse/sdk/identity/EidService$Companion;->log$mobilefuse_sdk_core_release(Ljava/lang/String;)V
    ...
    :cond_1
    iget-object v0, p0, Lcom/mobilefuse/sdk/identity/EidService;->eidRequestDebouncer:Lcom/mobilefuse/sdk/identity/EidRequestDebouncer;

    iget-object v2, p0, Lcom/mobilefuse/sdk/identity/EidService;->eidData:Lcom/mobilefuse/sdk/identity/EidSdkData;

    invoke-virtual {v0, v2, p1}, Lcom/mobilefuse/sdk/identity/EidRequestDebouncer;->debounceEidUpdate(Lcom/mobilefuse/sdk/identity/EidSdkData;Ljava/util/Set;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_0
    sget-object v0, Lcom/mobilefuse/sdk/identity/EidService$handleSdkStateChanged$$inlined$handleExceptions$1$wm$TryKt$WhenMappings;->$EnumSwitchMapping$0:[I
...
.method public final onNewEidDataError$mobilefuse_sdk_core_release(Lcom/mobilefuse/sdk/exception/BaseError;)V
    ...
    const-string v0, "An EID request failed with HTTP status code "

    const-string v1, "(-) Error server response for EID refresh request: "

    const-string v2, "(-) MFX EID managed mode is disabled: skipped processing EID response error: "
    ...
    invoke-virtual {v2, v1}, Lcom/mobilefuse/sdk/identity/EidService$Companion;->log$mobilefuse_sdk_core_release(Ljava/lang/String;)V

    instance-of v1, p1, Lcom/mobilefuse/sdk/network/client/HttpError$ConnectionError;
    ...
    iput-boolean v4, p0, Lcom/mobilefuse/sdk/identity/EidService;->requestPenaltyActive:Z

    iget-object v5, p0, Lcom/mobilefuse/sdk/identity/EidService;->eidRefreshMonitor:Lcom/mobilefuse/sdk/identity/EidRefreshMonitor;
    ...
    invoke-static/range {v5 .. v10}, Lcom/mobilefuse/sdk/identity/EidRefreshMonitor;->start$default(Lcom/mobilefuse/sdk/identity/EidRefreshMonitor;JZILjava/lang/Object;)Z
...
.method public final onNewEidDataReceived$mobilefuse_sdk_core_release(Lcom/mobilefuse/sdk/identity/EidSdkData;Ljava/util/Set;)V
    ...
    const-string v0, "(+) Received new EID data from server with altered EIDs for partners: "

    const-string v1, "eidData"

    invoke-static {p1, v1}, Lkotlin/jvm/internal/p;->f(Ljava/lang/Object;Ljava/lang/String;)V

    const-string v1, "alteredEids"
    ...
    :cond_0
    iget-boolean v3, p0, Lcom/mobilefuse/sdk/identity/EidService;->requestPenaltyActive:Z
    ...
    invoke-virtual {v3, v0}, Lcom/mobilefuse/sdk/identity/EidService$Companion;->log$mobilefuse_sdk_core_release(Ljava/lang/String;)V
...
.method public final overrideEid(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v1, "\" for partner \""

    const-string v2, "\". Ignore request."

    const-string v3, "(-) Already found EID value \""

    invoke-static {v3, p2, v1, p1, v2}, Landroidx/constraintlayout/core/dsl/a;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
