.class public Lcom/bytedance/sdk/openadsdk/rdp/fs;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/bytedance/sdk/openadsdk/rdp/fs;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/bytedance/sdk/openadsdk/rdp/fs;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1}, Lcom/bytedance/sdk/openadsdk/rdp/fs;->qdl(Landroid/content/Context;)V
...
.method private qdl(Landroid/content/Context;)V
    ...
    sget v0, Lcom/bytedance/sdk/openadsdk/utils/jtx;->syy:I
    ...
    invoke-direct {v2, v3}, Lcom/bytedance/sdk/openadsdk/core/mo/mml;-><init>(Landroid/content/Context;)V

    sget v3, Lcom/bytedance/sdk/openadsdk/utils/jtx;->ca:I
    ...
    invoke-direct {v1, p1}, Lcom/bytedance/sdk/openadsdk/core/mo/wd;-><init>(Landroid/content/Context;)V

    sget v2, Lcom/bytedance/sdk/openadsdk/utils/jtx;->tdy:I
    ...
    invoke-virtual {v1, v2}, Lcom/bytedance/sdk/openadsdk/core/mo/wd;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    new-instance v5, Lcom/bytedance/sdk/openadsdk/core/widget/qdl;

    invoke-direct {v5, p1}, Lcom/bytedance/sdk/openadsdk/core/widget/qdl;-><init>(Landroid/content/Context;)V

    sget v6, Lcom/bytedance/sdk/openadsdk/utils/jtx;->ax:I
    ...
    invoke-virtual {v5, v7}, Lcom/bytedance/sdk/openadsdk/core/mo/mml;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-direct {v5, p1}, Lcom/bytedance/sdk/openadsdk/core/mo/jpc;-><init>(Landroid/content/Context;)V

    sget v7, Lcom/bytedance/sdk/openadsdk/utils/jtx;->ag:I
    ...
    invoke-static {p1, v2}, Lcom/bytedance/sdk/openadsdk/utils/rq;->qdl(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v5, v2}, Lcom/bytedance/sdk/openadsdk/core/mo/jpc;->setGravity(I)V
    ...
    sget v10, Lcom/bytedance/sdk/openadsdk/utils/jtx;->wc:I
    ...
    invoke-virtual {v5, v11}, Lcom/bytedance/sdk/openadsdk/core/mo/jpc;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    sget v11, Lcom/bytedance/sdk/openadsdk/utils/jtx;->om:I
    ...
    invoke-static {p1, v12}, Lcom/bytedance/sdk/openadsdk/utils/ax;->ud(Landroid/content/Context;F)I

    move-result v12

    const/high16 v13, 0x41e00000    # 28.0f

    invoke-static {p1, v13}, Lcom/bytedance/sdk/openadsdk/utils/ax;->ud(Landroid/content/Context;F)I
    ...
    invoke-static {p1, v3}, Lcom/bytedance/sdk/openadsdk/utils/rq;->qdl(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v5, v2, p1, v2, p1}, Lcom/bytedance/sdk/openadsdk/core/mo/jpc;->setPadding(IIII)V
