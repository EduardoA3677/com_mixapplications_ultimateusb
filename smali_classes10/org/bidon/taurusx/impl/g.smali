.class public final Lorg/bidon/taurusx/impl/g;
...
.field public c:Lcom/taurusx/tax/api/TaurusXInterstitialAds;

.field public final d:Lorg/bidon/taurusx/impl/f;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bidon/taurusx/impl/g;->a:Lorg/bidon/sdk/adapter/impl/AdEventFlowImpl;
    ...
    iput-object v0, p0, Lorg/bidon/taurusx/impl/g;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;

    new-instance v0, Lorg/bidon/taurusx/impl/f;

    invoke-direct {v0, p0}, Lorg/bidon/taurusx/impl/f;-><init>(Lorg/bidon/taurusx/impl/g;)V

    iput-object v0, p0, Lorg/bidon/taurusx/impl/g;->d:Lorg/bidon/taurusx/impl/f;
...
.method public final addAuctionConfigurationId(J)V
    ...
    iget-object v0, p0, Lorg/bidon/taurusx/impl/g;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
...
.method public final destroy()V
    ...
    iget-object v0, p0, Lorg/bidon/taurusx/impl/g;->c:Lcom/taurusx/tax/api/TaurusXInterstitialAds;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/taurusx/tax/api/TaurusXInterstitialAds;->destroy()V

    :cond_0
    const/4 v0, 0x0

    iput-object v0, p0, Lorg/bidon/taurusx/impl/g;->c:Lcom/taurusx/tax/api/TaurusXInterstitialAds;
...
.method public final emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
    ...
    iget-object v0, p0, Lorg/bidon/taurusx/impl/g;->a:Lorg/bidon/sdk/adapter/impl/AdEventFlowImpl;
...
.method public final load(Lorg/bidon/sdk/adapter/AdAuctionParams;)V
    ...
    check-cast p1, Lorg/bidon/taurusx/impl/e;
    ...
    const-string v1, "Starting interstitial load"

    invoke-static {v0, v1}, Lorg/bidon/sdk/logs/logging/impl/LogExtKt;->logInfo(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p1, Lorg/bidon/taurusx/impl/e;->d:Ljava/lang/String;

    iget-object v1, p0, Lorg/bidon/taurusx/impl/g;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
    ...
    invoke-virtual {p0, p1}, Lorg/bidon/taurusx/impl/g;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V

    return-void

    :cond_0
    iget-object v2, p1, Lorg/bidon/taurusx/impl/e;->b:Lorg/bidon/sdk/auction/models/AdUnit;

    invoke-virtual {v2}, Lorg/bidon/sdk/auction/models/AdUnit;->getBidType()Lorg/bidon/sdk/stats/models/BidType;

    move-result-object v2

    iget-object v3, p1, Lorg/bidon/taurusx/impl/e;->e:Ljava/lang/String;
    ...
    :cond_1
    new-instance v1, Lcom/taurusx/tax/api/TaurusXInterstitialAds;

    iget-object p1, p1, Lorg/bidon/taurusx/impl/e;->a:Landroid/content/Context;

    invoke-direct {v1, p1}, Lcom/taurusx/tax/api/TaurusXInterstitialAds;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lorg/bidon/taurusx/impl/g;->c:Lcom/taurusx/tax/api/TaurusXInterstitialAds;

    invoke-virtual {v1, v0}, Lcom/taurusx/tax/api/TaurusXInterstitialAds;->setAdUnitId(Ljava/lang/String;)V

    iget-object p1, p0, Lorg/bidon/taurusx/impl/g;->d:Lorg/bidon/taurusx/impl/f;

    invoke-virtual {v1, p1}, Lcom/taurusx/tax/api/TaurusXInterstitialAds;->setListener(Lcom/taurusx/tax/api/OnTaurusXInterstitialListener;)V

    if-ne v2, v4, :cond_2

    invoke-virtual {v1, v3}, Lcom/taurusx/tax/api/TaurusXInterstitialAds;->loadInterstitialFromBid(Ljava/lang/String;)V

    return-void

    :cond_2
    invoke-virtual {v1}, Lcom/taurusx/tax/api/TaurusXInterstitialAds;->loadInterstitial()V
...
.method public final show(Landroid/app/Activity;)V
    ...
    invoke-virtual {p0}, Lorg/bidon/taurusx/impl/g;->isAdReadyToShow()Z

    move-result p1

    if-eqz p1, :cond_1

    iget-object p1, p0, Lorg/bidon/taurusx/impl/g;->c:Lcom/taurusx/tax/api/TaurusXInterstitialAds;
