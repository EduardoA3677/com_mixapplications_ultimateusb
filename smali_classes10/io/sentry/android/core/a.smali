...
.field public final b:Lcom/google/android/exoplayer2/analytics/n;

.field public final c:Lio/sentry/android/core/r0;

.field public final d:Lio/bidmachine/h;
...
.field public final k:Lf2/q1;


# direct methods
.method public constructor <init>(JZLcom/google/android/exoplayer2/analytics/n;Lio/sentry/ILogger;Landroid/content/Context;)V
    .locals 4
    ...
    invoke-direct {v1, v2}, Lio/sentry/android/core/r0;-><init>(I)V
    ...
    iput-object v0, p0, Lio/sentry/android/core/a;->d:Lio/bidmachine/h;
    ...
    iput-object p4, p0, Lio/sentry/android/core/a;->b:Lcom/google/android/exoplayer2/analytics/n;

    iput-object p5, p0, Lio/sentry/android/core/a;->g:Lio/sentry/ILogger;

    iput-object v1, p0, Lio/sentry/android/core/a;->c:Lio/sentry/android/core/r0;

    iput-object p6, p0, Lio/sentry/android/core/a;->j:Landroid/content/Context;

    new-instance p3, Lf2/q1;

    invoke-direct {p3, p0, v0}, Lf2/q1;-><init>(Lio/sentry/android/core/a;Lio/bidmachine/h;)V

    iput-object p3, p0, Lio/sentry/android/core/a;->k:Lf2/q1;
...
.method public final run()V
    ...
    iget-object v0, p0, Lio/sentry/android/core/a;->k:Lf2/q1;
    ...
    iget-object v0, p0, Lio/sentry/android/core/a;->c:Lio/sentry/android/core/r0;

    iget-object v1, p0, Lio/sentry/android/core/a;->k:Lf2/q1;
    ...
    iget-object v0, p0, Lio/sentry/android/core/a;->d:Lio/bidmachine/h;
    ...
    iget-object v4, p0, Lio/sentry/android/core/a;->c:Lio/sentry/android/core/r0;

    iget-object v4, v4, Lio/sentry/android/core/r0;->a:Landroid/os/Handler;
    ...
    iget-object v0, p0, Lio/sentry/android/core/a;->b:Lcom/google/android/exoplayer2/analytics/n;

    iget-object v4, v0, Lcom/google/android/exoplayer2/analytics/n;->b:Ljava/lang/Object;
    ...
    invoke-interface {v4, v5, v7, v6}, Lio/sentry/ILogger;->h(Lio/sentry/r5;Ljava/lang/String;[Ljava/lang/Object;)V

    sget-object v4, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    sget-object v5, Lio/sentry/android/core/e0;->e:Lio/sentry/android/core/e0;

    iget-object v5, v5, Lio/sentry/android/core/e0;->d:Ljava/lang/Boolean;
    ...
    iput-object v3, v0, Lio/sentry/protocol/m;->a:Ljava/lang/String;
    ...
    invoke-direct {v3, v0, v1, v5, v2}, Lio/sentry/exception/a;-><init>(Lio/sentry/protocol/m;Ljava/lang/Throwable;Ljava/lang/Thread;Z)V

    new-instance v0, Lio/sentry/i5;

    invoke-direct {v0, v3}, Lio/sentry/i5;-><init>(Ljava/lang/Throwable;)V

    sget-object v1, Lio/sentry/r5;->ERROR:Lio/sentry/r5;

    iput-object v1, v0, Lio/sentry/i5;->u:Lio/sentry/r5;

    new-instance v1, Lio/sentry/android/core/w;

    invoke-direct {v1, v4}, Lio/sentry/android/core/w;-><init>(Z)V
    ...
    invoke-interface {v2, v0, v1}, Lio/sentry/e1;->D(Lio/sentry/i5;Lio/sentry/l0;)Lio/sentry/protocol/v;
