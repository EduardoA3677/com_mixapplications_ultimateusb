...
.field public g:Lcom/my/target/nativeads/NativeBannerAdLoader$OnLoad;
...
.method public constructor <init>(IILandroid/content/Context;Lcom/my/target/common/menu/MenuFactory;)V
    ...
    const-string v0, "NativeBannerAdLoader: Invalid bannersCount < 1, bannersCount set to "
    ...
    iput-object p1, p0, Lcom/my/target/nativeads/NativeBannerAdLoader;->e:Landroid/content/Context;

    iput-object p4, p0, Lcom/my/target/nativeads/NativeBannerAdLoader;->f:Lcom/my/target/common/menu/MenuFactory;

    new-instance p1, Ljava/lang/StringBuilder;

    const-string p2, "Native banner ad loader created. Version - "
...
.method private synthetic a(Lcom/my/target/l;Lcom/my/target/o7;Lcom/my/target/m;)V
    .locals 1

    iget-object v0, p0, Lcom/my/target/nativeads/NativeBannerAdLoader;->h:Lcom/my/target/l;

    if-ne p1, v0, :cond_0

    const/4 p1, 0x0

    iput-object p1, p0, Lcom/my/target/nativeads/NativeBannerAdLoader;->h:Lcom/my/target/l;

    invoke-direct {p0, p2, p3}, Lcom/my/target/nativeads/NativeBannerAdLoader;->a(Lcom/my/target/o7;Lcom/my/target/common/models/IAdLoadingError;)V

    :cond_0
    return-void
.end method

.method public static synthetic a(Lcom/my/target/nativeads/NativeBannerAdLoader;Lcom/my/target/l;Lcom/my/target/o7;Lcom/my/target/m;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/my/target/nativeads/NativeBannerAdLoader;->a(Lcom/my/target/l;Lcom/my/target/o7;Lcom/my/target/m;)V
...
.method private a(Lcom/my/target/o7;Lcom/my/target/common/models/IAdLoadingError;)V
    ...
    iget-object p2, p0, Lcom/my/target/nativeads/NativeBannerAdLoader;->g:Lcom/my/target/nativeads/NativeBannerAdLoader$OnLoad;
    ...
    iget-object v3, p0, Lcom/my/target/nativeads/NativeBannerAdLoader;->f:Lcom/my/target/common/menu/MenuFactory;

    iget-object v4, p0, Lcom/my/target/nativeads/NativeBannerAdLoader;->e:Landroid/content/Context;
    ...
    invoke-virtual {v1, v2, v0}, Lcom/my/target/nativeads/NativeBannerAd;->a(Lcom/my/target/j;Lcom/my/target/b7;)V
    ...
    :cond_3
    iget-object p1, p0, Lcom/my/target/nativeads/NativeBannerAdLoader;->g:Lcom/my/target/nativeads/NativeBannerAdLoader$OnLoad;
...
.method public load()Lcom/my/target/nativeads/NativeBannerAdLoader;
    ...
    invoke-virtual {v0, v3, v3}, Lcom/my/target/o;->b(II)V
    ...
    new-instance v1, Lcom/my/target/i7$b;

    invoke-direct {v1}, Lcom/my/target/i7$b;-><init>()V
    ...
    iput-object v1, p0, Lcom/my/target/nativeads/NativeBannerAdLoader;->h:Lcom/my/target/l;
    ...
    iget-object v2, p0, Lcom/my/target/nativeads/NativeBannerAdLoader;->e:Landroid/content/Context;
...
.method public setOnLoad(Lcom/my/target/nativeads/NativeBannerAdLoader$OnLoad;)Lcom/my/target/nativeads/NativeBannerAdLoader;
    .locals 0
    .param p1    # Lcom/my/target/nativeads/NativeBannerAdLoader$OnLoad;
    ...
    iput-object p1, p0, Lcom/my/target/nativeads/NativeBannerAdLoader;->g:Lcom/my/target/nativeads/NativeBannerAdLoader$OnLoad;
