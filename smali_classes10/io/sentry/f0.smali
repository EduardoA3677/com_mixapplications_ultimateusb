...
# direct methods
.method public constructor <init>(Lio/sentry/e1;Lio/sentry/j1;Lio/sentry/ILogger;JI)V
    .locals 6
    ...
    iput-object v1, v0, Lio/sentry/f0;->e:Lio/sentry/e1;

    const-string p1, "Serializer is required."

    invoke-static {p2, p1}, Lio/sentry/util/l;->b(Ljava/lang/Object;Ljava/lang/String;)V

    iput-object p2, v0, Lio/sentry/f0;->f:Lio/sentry/j1;

    const-string p1, "Logger is required."

    invoke-static {v2, p1}, Lio/sentry/util/l;->b(Ljava/lang/Object;Ljava/lang/String;)V

    iput-object v2, v0, Lio/sentry/f0;->g:Lio/sentry/ILogger;

    return-void
.end method

.method public static c(Lio/sentry/f0;Ljava/io/File;Lio/sentry/hints/h;)V
    .locals 4

    iget-object p0, p0, Lio/sentry/f0;->g:Lio/sentry/ILogger;
    ...
    invoke-interface {p0, v1, v0, v2}, Lio/sentry/ILogger;->h(Lio/sentry/r5;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    ...
    invoke-interface {p0, v2, v1, v0, p2}, Lio/sentry/ILogger;->g(Lio/sentry/r5;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-interface {p0, p2, v0, p1}, Lio/sentry/ILogger;->h(Lio/sentry/r5;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public final b(Ljava/io/File;Lio/sentry/l0;)V
    ...
    iget-object v3, p0, Lio/sentry/f0;->g:Lio/sentry/ILogger;
    ...
    :try_start_1
    iget-object v5, p0, Lio/sentry/f0;->f:Lio/sentry/j1;

    invoke-interface {v5, v4}, Lio/sentry/j1;->d(Ljava/io/BufferedInputStream;)Lio/sentry/a5;
    ...
    :cond_3
    iget-object v6, p0, Lio/sentry/f0;->e:Lio/sentry/e1;

    invoke-interface {v6, v5, p2}, Lio/sentry/e1;->x(Lio/sentry/a5;Lio/sentry/l0;)Lio/sentry/protocol/v;
    ...
    check-cast v6, Lio/sentry/hints/g;

    invoke-interface {v6}, Lio/sentry/hints/g;->g()Z
    ...
    :cond_4
    invoke-static {v5, v6, v3}, Lio/sentry/util/j;->a(Ljava/lang/Class;Ljava/lang/Object;Lio/sentry/ILogger;)V
    :try_end_1
    ...
    invoke-static {p0, p1, v2}, Lio/sentry/f0;->c(Lio/sentry/f0;Ljava/io/File;Lio/sentry/hints/h;)V

    return-void

    :cond_6
    invoke-static {v0, v2, v3}, Lio/sentry/util/j;->a(Ljava/lang/Class;Ljava/lang/Object;Lio/sentry/ILogger;)V
    ...
    invoke-interface {v3, v5, v4, v6, v7}, Lio/sentry/ILogger;->g(Lio/sentry/r5;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    check-cast v5, Lio/sentry/hints/h;

    invoke-interface {v5, v2}, Lio/sentry/hints/h;->d(Z)V
    ...
    invoke-interface {v3, v2, v4, v5, v6}, Lio/sentry/ILogger;->g(Lio/sentry/r5;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V

    goto :goto_5

    :cond_7
    invoke-static {v0, v5, v3}, Lio/sentry/util/j;->a(Ljava/lang/Class;Ljava/lang/Object;Lio/sentry/ILogger;)V
    :try_end_5
    ...
    invoke-interface {v3, v4, v2, v5, v6}, Lio/sentry/ILogger;->g(Lio/sentry/r5;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_6
    ...
    invoke-static {p0, p1, v4}, Lio/sentry/f0;->c(Lio/sentry/f0;Ljava/io/File;Lio/sentry/hints/h;)V

    goto :goto_b

    :cond_9
    invoke-static {v0, v4, v3}, Lio/sentry/util/j;->a(Ljava/lang/Class;Ljava/lang/Object;Lio/sentry/ILogger;)V
