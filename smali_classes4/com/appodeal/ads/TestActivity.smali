...
.field public f:Lcom/appodeal/ads/nativead/NativeAdViewContentStream;

.field public g:Lcom/appodeal/ads/NativeAd;

.field public h:Lcom/appodeal/ads/b6;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/appodeal/ads/TestActivity;->h:Lcom/appodeal/ads/b6;
...
.method public static a()V
    ...
    invoke-virtual {v1}, Lcom/appodeal/ads/s;->t()Lcom/appodeal/ads/b6;
    ...
    invoke-virtual {v3}, Lcom/appodeal/ads/s;->t()Lcom/appodeal/ads/b6;

    move-result-object v3

    check-cast v3, Lcom/appodeal/ads/u5;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/appodeal/ads/b6;->g()V

    invoke-virtual {v0}, Lcom/appodeal/ads/b6;->o()V
    ...
    invoke-virtual {v1}, Lcom/appodeal/ads/b6;->o()V

    :cond_1
    if-eqz v2, :cond_2

    invoke-virtual {v2}, Lcom/appodeal/ads/b6;->g()V

    invoke-virtual {v2}, Lcom/appodeal/ads/b6;->o()V

    :cond_2
    if-eqz v3, :cond_3

    invoke-virtual {v3}, Lcom/appodeal/ads/b6;->g()V

    invoke-virtual {v3}, Lcom/appodeal/ads/b6;->o()V
...
.method public final c()V
    ...
    invoke-virtual {p0}, Lcom/appodeal/ads/TestActivity;->g()V

    :cond_0
    sget-object v0, Lcom/appodeal/ads/context/k;->b:Lcom/appodeal/ads/context/k;
    ...
    iget-object v0, v0, Lcom/appodeal/ads/context/k;->a:Lcom/appodeal/ads/context/j;

    invoke-virtual {v0, v1}, Lcom/appodeal/ads/context/j;->setApplicationContext(Landroid/content/Context;)V

    sget-object v0, Lcom/appodeal/ads/context/f;->b:Lcom/appodeal/ads/context/f;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v0, v0, Lcom/appodeal/ads/context/f;->a:Lcom/appodeal/ads/context/c;
    ...
    iput-object v1, v0, Lcom/appodeal/ads/context/c;->b:Ljava/lang/ref/WeakReference;
    ...
    :goto_0
    iget-object v0, p0, Lcom/appodeal/ads/TestActivity;->h:Lcom/appodeal/ads/b6;
    ...
    invoke-static {v12, v1, v13}, Landroid/graphics/BitmapFactory;->decodeByteArray([BII)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v13, v12, v12}, Landroid/graphics/drawable/BitmapDrawable;->setTileModeXY(Landroid/graphics/Shader$TileMode;Landroid/graphics/Shader$TileMode;)V
    ...
    iput-object v8, p0, Lcom/appodeal/ads/TestActivity;->c:Landroid/widget/ListView;

    const/4 v12, 0x0

    invoke-virtual {v8, v12}, Landroid/widget/ListView;->setDivider(Landroid/graphics/drawable/Drawable;)V

    iget-object v8, p0, Lcom/appodeal/ads/TestActivity;->c:Landroid/widget/ListView;
    ...
    invoke-virtual {v8, v4, v13}, Landroid/widget/RelativeLayout$LayoutParams;->addRule(II)V

    iget-object v4, p0, Lcom/appodeal/ads/TestActivity;->c:Landroid/widget/ListView;

    invoke-virtual {v4, v8}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget v4, p0, Lcom/appodeal/ads/TestActivity;->a:I

    const/4 v8, -0x2

    if-nez v4, :cond_7

    const-string v4, "CHOOSE AD TYPE"

    invoke-virtual {v7, v4}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    new-instance v4, Lcom/appodeal/ads/utils/debug/a;

    invoke-direct {v4, p0, v6}, Landroid/widget/ArrayAdapter;-><init>(Landroid/content/Context;I)V
    ...
    new-instance v13, Lcom/appodeal/ads/c2;

    const/4 v14, 0x0

    invoke-direct {v13, p0, v14}, Lcom/appodeal/ads/c2;-><init>(Lcom/appodeal/ads/TestActivity;I)V

    invoke-virtual {v4, v13}, Landroid/widget/AdapterView;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    new-instance v7, Lcom/appodeal/ads/d2;

    const/4 v10, 0x0

    invoke-direct {v7, p0, v10}, Lcom/appodeal/ads/d2;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-virtual {v7, v1, v1, v9, v1}, Landroid/view/ViewGroup$MarginLayoutParams;->setMargins(IIII)V
    ...
    :cond_7
    const-string v4, "CHOOSE AD ITEM"

    invoke-virtual {v7, v4}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v4, p0, Lcom/appodeal/ads/TestActivity;->h:Lcom/appodeal/ads/b6;

    iget-object v4, v4, Lcom/appodeal/ads/b6;->a:Ljava/util/ArrayList;

    invoke-static {v4, v1}, Lo4/a;->f(Ljava/util/ArrayList;Z)Ljava/util/ArrayList;
    ...
    invoke-direct {v9, v4}, Ljava/util/LinkedHashSet;-><init>(Ljava/util/Collection;)V

    invoke-direct {v7, v9}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    new-instance v4, Lcom/appodeal/ads/utils/debug/k;

    invoke-direct {v4, p0, v7}, Lcom/appodeal/ads/utils/debug/k;-><init>(Lcom/appodeal/ads/TestActivity;Ljava/util/ArrayList;)V
    ...
    new-instance v7, Lcom/appodeal/ads/c2;

    const/4 v9, 0x1

    invoke-direct {v7, p0, v9}, Lcom/appodeal/ads/c2;-><init>(Lcom/appodeal/ads/TestActivity;I)V
    ...
    iput-object v4, p0, Lcom/appodeal/ads/TestActivity;->d:Landroid/widget/RelativeLayout;
    ...
    :cond_8
    new-instance v1, Lcom/appodeal/ads/nativead/NativeAdViewContentStream;

    invoke-direct {v1, p0}, Lcom/appodeal/ads/nativead/NativeAdViewContentStream;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lcom/appodeal/ads/TestActivity;->f:Lcom/appodeal/ads/nativead/NativeAdViewContentStream;

    invoke-static {v6, v8, v4}, Lb/a;->h(III)Landroid/widget/RelativeLayout$LayoutParams;

    move-result-object v1

    iget-object v2, p0, Lcom/appodeal/ads/TestActivity;->d:Landroid/widget/RelativeLayout;

    iget-object v3, p0, Lcom/appodeal/ads/TestActivity;->f:Lcom/appodeal/ads/nativead/NativeAdViewContentStream;
    ...
    :cond_9
    invoke-static {p0}, Lcom/appodeal/ads/Appodeal;->getMrecView(Landroid/content/Context;)Lcom/appodeal/ads/MrecView;
    ...
    :cond_a
    invoke-static {p0}, Lcom/appodeal/ads/Appodeal;->getBannerView(Landroid/content/Context;)Lcom/appodeal/ads/BannerView;
    ...
    invoke-static {p0}, Lcom/appodeal/ads/Appodeal;->setMrecCallbacks(Lcom/appodeal/ads/MrecCallbacks;)V

    invoke-static {p0}, Lcom/appodeal/ads/Appodeal;->setInterstitialCallbacks(Lcom/appodeal/ads/InterstitialCallbacks;)V

    invoke-static {p0}, Lcom/appodeal/ads/Appodeal;->setRewardedVideoCallbacks(Lcom/appodeal/ads/RewardedVideoCallbacks;)V
...
.method public final d()V
    ...
    iget-object v0, p0, Lcom/appodeal/ads/TestActivity;->f:Lcom/appodeal/ads/nativead/NativeAdViewContentStream;
    ...
    invoke-virtual {v0}, Lcom/appodeal/ads/nativead/NativeAdView;->unregisterView()V
...
.method public final onBackPressed()V
    ...
    sput-object v0, Lcom/appodeal/ads/h0;->c:Lcom/appodeal/ads/TestActivity;
...
.method public final onBannerClicked()V
    ...
    invoke-static {v0, v1}, Lcom/appodeal/ads/TestActivity;->b(Landroid/content/Context;Ljava/lang/String;)V
...
.method public final onBannerLoaded(IZ)V
    ...
    invoke-static {p0, p1}, Lcom/appodeal/ads/Appodeal;->show(Landroid/app/Activity;I)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-virtual {p0}, Lcom/appodeal/ads/TestActivity;->f()V
    ...
    invoke-static {p1, p2}, Lcom/appodeal/ads/TestActivity;->b(Landroid/content/Context;Ljava/lang/String;)V
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    :cond_0
    sput-object p0, Lcom/appodeal/ads/h0;->c:Lcom/appodeal/ads/TestActivity;
...
.method public final onMrecLoaded(Z)V
    ...
    invoke-static {p1, v0}, Lcom/appodeal/ads/TestActivity;->b(Landroid/content/Context;Ljava/lang/String;)V
...
.method public final onNativeLoaded()V
    ...
    new-instance v0, Lcom/appodeal/ads/nativead/NativeAdViewContentStream;

    invoke-direct {v0, p0}, Lcom/appodeal/ads/nativead/NativeAdViewContentStream;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/appodeal/ads/TestActivity;->f:Lcom/appodeal/ads/nativead/NativeAdViewContentStream;
    ...
    invoke-static {v2, v0, v1}, Lb/a;->h(III)Landroid/widget/RelativeLayout$LayoutParams;

    move-result-object v0

    iget-object v1, p0, Lcom/appodeal/ads/TestActivity;->f:Lcom/appodeal/ads/nativead/NativeAdViewContentStream;

    const/high16 v3, -0x10000

    invoke-virtual {v1, v3}, Lcom/appodeal/ads/nativead/NativeAdView;->setAdAttributionBackground(I)V

    iget-object v1, p0, Lcom/appodeal/ads/TestActivity;->f:Lcom/appodeal/ads/nativead/NativeAdViewContentStream;

    invoke-virtual {v1, v2}, Lcom/appodeal/ads/nativead/NativeAdView;->setAdAttributionTextColor(I)V

    iget-object v1, p0, Lcom/appodeal/ads/TestActivity;->f:Lcom/appodeal/ads/nativead/NativeAdViewContentStream;

    sget-object v2, Lcom/appodeal/ads/nativead/Position;->END_BOTTOM:Lcom/appodeal/ads/nativead/Position;

    invoke-virtual {v1, v2}, Lcom/appodeal/ads/nativead/NativeAdView;->setAdChoicesPosition(Lcom/appodeal/ads/nativead/Position;)V

    iget-object v1, p0, Lcom/appodeal/ads/TestActivity;->f:Lcom/appodeal/ads/nativead/NativeAdViewContentStream;

    iget-object v2, p0, Lcom/appodeal/ads/TestActivity;->g:Lcom/appodeal/ads/NativeAd;

    invoke-virtual {v1, v2}, Lcom/appodeal/ads/nativead/NativeAdView;->registerView(Lcom/appodeal/ads/NativeAd;)Z

    iget-object v1, p0, Lcom/appodeal/ads/TestActivity;->d:Landroid/widget/RelativeLayout;

    iget-object v2, p0, Lcom/appodeal/ads/TestActivity;->f:Lcom/appodeal/ads/nativead/NativeAdViewContentStream;
