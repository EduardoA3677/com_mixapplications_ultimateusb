...
.method private static final _get_type_$lambda$1(Lkotlin/reflect/jvm/internal/KParameterImpl;)Ljava/lang/reflect/Type;
    ...
    invoke-virtual {v0, v1}, Lkotlin/reflect/jvm/internal/calls/ValueClassAwareCaller;->getRealSlicesOfParameters(I)Lbe/i;

    move-result-object v1

    invoke-virtual {v0, v2}, Lkotlin/reflect/jvm/internal/calls/ValueClassAwareCaller;->getRealSlicesOfParameters(I)Lbe/i;
    ...
    iget v6, v1, Lbe/g;->a:I

    sub-int/2addr v6, v4

    iget v1, v1, Lbe/g;->b:I

    sub-int/2addr v1, v4

    invoke-direct {v5, v6, v1, v3}, Lbe/g;-><init>(III)V

    invoke-static {v5, v0}, Lhd/t;->s1(Lbe/i;Ljava/util/List;)Ljava/util/List;
...
.method public static synthetic accessor$KParameterImpl$lambda0(Lkotlin/reflect/jvm/internal/KParameterImpl;)Ljava/util/List;
    .locals 0
...
.method public static synthetic accessor$KParameterImpl$lambda1(Lkotlin/reflect/jvm/internal/KParameterImpl;)Ljava/lang/reflect/Type;
    .locals 0
...
.method private final varargs compoundType([Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;
    ...
    :cond_0
    invoke-static {p1}, Lhd/q;->D0([Ljava/lang/Object;)Ljava/lang/Object;
