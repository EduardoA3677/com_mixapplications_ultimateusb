.class public final Lorg/bidon/vungle/impl/i;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bidon/vungle/impl/i;->a:Lorg/bidon/sdk/adapter/impl/AdEventFlowImpl;
    ...
    iput-object v0, p0, Lorg/bidon/vungle/impl/i;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
...
.method public final addAuctionConfigurationId(J)V
    ...
    iget-object v0, p0, Lorg/bidon/vungle/impl/i;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
...
.method public final destroy()V
    ...
    iget-object v0, p0, Lorg/bidon/vungle/impl/i;->c:Lcom/vungle/ads/RewardedAd;
    ...
    :cond_0
    iput-object v1, p0, Lorg/bidon/vungle/impl/i;->c:Lcom/vungle/ads/RewardedAd;
...
.method public final emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
    ...
    iget-object v0, p0, Lorg/bidon/vungle/impl/i;->a:Lorg/bidon/sdk/adapter/impl/AdEventFlowImpl;
...
.method public final load(Lorg/bidon/sdk/adapter/AdAuctionParams;)V
    ...
    iget-object v0, p1, Lorg/bidon/vungle/impl/e;->e:Ljava/lang/String;
    ...
    const-string v2, "VungleRewardedImpl"

    invoke-static {v2, v1}, Lorg/bidon/sdk/logs/logging/impl/LogExtKt;->logInfo(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p1, Lorg/bidon/vungle/impl/e;->d:Ljava/lang/String;

    iget-object v2, p0, Lorg/bidon/vungle/impl/i;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
    ...
    invoke-virtual {p0, p1}, Lorg/bidon/vungle/impl/i;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V

    return-void

    :cond_0
    new-instance v3, Lcom/vungle/ads/RewardedAd;

    iget-object v4, p1, Lorg/bidon/vungle/impl/e;->a:Landroid/app/Activity;

    new-instance v5, Lcom/vungle/ads/AdConfig;

    invoke-direct {v5}, Lcom/vungle/ads/AdConfig;-><init>()V

    invoke-direct {v3, v4, v1, v5}, Lcom/vungle/ads/RewardedAd;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/vungle/ads/AdConfig;)V

    iput-object v3, p0, Lorg/bidon/vungle/impl/i;->c:Lcom/vungle/ads/RewardedAd;

    new-instance v1, Lorg/bidon/vungle/impl/h;

    invoke-direct {v1, p0, p1}, Lorg/bidon/vungle/impl/h;-><init>(Lorg/bidon/vungle/impl/i;Lorg/bidon/vungle/impl/e;)V

    invoke-virtual {v3, v1}, Lcom/vungle/ads/BaseAd;->setAdListener(Lcom/vungle/ads/BaseAdListener;)V

    iget-object p1, p1, Lorg/bidon/vungle/impl/e;->b:Lorg/bidon/sdk/auction/models/AdUnit;
    ...
    :cond_1
    invoke-virtual {v3, v0}, Lcom/vungle/ads/BaseFullscreenAd;->load(Ljava/lang/String;)V
...
.method public final show(Landroid/app/Activity;)V
    ...
    invoke-virtual {p0}, Lorg/bidon/vungle/impl/i;->isAdReadyToShow()Z

    move-result p1

    if-eqz p1, :cond_1

    iget-object p1, p0, Lorg/bidon/vungle/impl/i;->c:Lcom/vungle/ads/RewardedAd;
