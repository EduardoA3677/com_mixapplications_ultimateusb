.class public final Lorg/bidon/chartboost/impl/h;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bidon/chartboost/impl/h;->a:Lorg/bidon/sdk/adapter/impl/AdEventFlowImpl;
    ...
    iput-object v0, p0, Lorg/bidon/chartboost/impl/h;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
...
.method public final addAuctionConfigurationId(J)V
    ...
    iget-object v0, p0, Lorg/bidon/chartboost/impl/h;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
...
.method public final destroy()V
    ...
    iget-object v0, p0, Lorg/bidon/chartboost/impl/h;->c:Li0/f;

    if-eqz v0, :cond_0

    iget-object v0, v0, Li0/f;->e:Ll0/j5;
    ...
    iput-object v0, p0, Lorg/bidon/chartboost/impl/h;->c:Li0/f;
...
.method public final emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
    ...
    iget-object v0, p0, Lorg/bidon/chartboost/impl/h;->a:Lorg/bidon/sdk/adapter/impl/AdEventFlowImpl;
...
.method public final load(Lorg/bidon/sdk/adapter/AdAuctionParams;)V
    ...
    new-instance v0, Lorg/bidon/chartboost/impl/g;

    invoke-direct {v0, p0, p1}, Lorg/bidon/chartboost/impl/g;-><init>(Lorg/bidon/chartboost/impl/h;Lorg/bidon/chartboost/impl/f;)V
    ...
    invoke-direct {v1, p1, v0, v2}, Li0/f;-><init>(Ljava/lang/String;Lorg/bidon/chartboost/impl/g;Lh0/c;)V

    iput-object v1, p0, Lorg/bidon/chartboost/impl/h;->c:Li0/f;

    iget-object v2, v1, Li0/f;->e:Ll0/j5;
    ...
    :goto_0
    const-string v3, "ChartboostInterstitialImpl"
    ...
    iget-object p1, p0, Lorg/bidon/chartboost/impl/h;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
    ...
    invoke-virtual {p0, v0}, Lorg/bidon/chartboost/impl/h;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
    ...
    invoke-virtual {v1}, Li0/f;->a()V

    return-void

    :cond_3
    iget-object v2, v1, Li0/f;->d:Lgd/o;

    invoke-virtual {v2}, Lgd/o;->getValue()Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Ll0/g8;
    ...
    iget-object v3, v2, Ll0/g8;->l:Ll0/o6;
...
.method public final show(Landroid/app/Activity;)V
    ...
    invoke-virtual {p0}, Lorg/bidon/chartboost/impl/h;->isAdReadyToShow()Z

    move-result p1

    if-eqz p1, :cond_4

    iget-object p1, p0, Lorg/bidon/chartboost/impl/h;->c:Li0/f;
    ...
    :cond_4
    const-string p1, "ChartboostInterstitialImpl"
    ...
    invoke-virtual {p0, p1}, Lorg/bidon/chartboost/impl/h;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
