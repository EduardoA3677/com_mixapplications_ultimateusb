...
.method private static final readColumns(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {v2, v5}, Ll0/u9;->t(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v10}, Lid/g;-><init>()V
    ...
    invoke-virtual {v10, v13, v12}, Lid/g;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    goto :goto_0

    :cond_2
    invoke-virtual {v10}, Lid/g;->g()Lid/g;
...
.method private static final readForeignKeyFieldMappings(Landroid/database/Cursor;)Ljava/util/List;
    ...
    invoke-virtual {v4, v5}, Lid/d;->add(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Lhd/t;->t1(Ljava/lang/Iterable;)Ljava/util/List;
...
.method private static final readForeignKeys(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    new-instance v6, Lid/j;

    invoke-direct {v6}, Lid/j;-><init>()V
    ...
    invoke-static {v11, v7}, Lkotlin/jvm/internal/p;->e(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v8}, Lid/j;->add(Ljava/lang/Object;)Z

    goto/16 :goto_0

    :cond_4
    invoke-static {v6}, Lxd/a;->n(Lid/j;)Lid/j;
...
.method private static final readIndex(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;Z)Landroidx/room/util/TableInfo$Index;
    ...
    invoke-static {p0, v6}, Ll0/u9;->t(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final readIndices(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-static {p1, v6}, Ll0/u9;->t(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    return-object v6

    :cond_3
    :try_start_1
    invoke-virtual {v5, v7}, Lid/j;->add(Ljava/lang/Object;)Z
    ...
    :cond_4
    invoke-static {v5}, Lxd/a;->n(Lid/j;)Lid/j;
