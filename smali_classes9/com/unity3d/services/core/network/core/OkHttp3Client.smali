...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "client",
        "<init>",
        "(Lcom/unity3d/services/core/domain/ISDKDispatchers;Lbf/e0;)V",
...
.method public constructor <init>(Lcom/unity3d/services/core/domain/ISDKDispatchers;Lbf/e0;)V
    .locals 1
    ...
    iput-object p2, p0, Lcom/unity3d/services/core/network/core/OkHttp3Client;->client:Lbf/e0;
...
.method public execute(Lcom/unity3d/services/core/network/model/HttpRequest;ZLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :try_start_1
    invoke-static {p1}, Lcom/unity3d/services/core/network/mapper/HttpRequestToOkHttpRequestKt;->toOkHttpProtoRequest(Lcom/unity3d/services/core/network/model/HttpRequest;)Lbf/h0;

    move-result-object p3

    iget-object v2, p0, Lcom/unity3d/services/core/network/core/OkHttp3Client;->client:Lbf/e0;
    ...
    invoke-virtual {v2, v4, v5, v6}, Lbf/d0;->b(JLjava/util/concurrent/TimeUnit;)V
    ...
    invoke-virtual {v2, v4, v5, v6}, Lbf/d0;->c(JLjava/util/concurrent/TimeUnit;)V
    ...
    invoke-static {v4, v5, v6}, Lcf/b;->b(JLjava/util/concurrent/TimeUnit;)I

    move-result v4

    iput v4, v2, Lbf/d0;->z:I

    new-instance v4, Lbf/e0;

    invoke-direct {v4, v2}, Lbf/e0;-><init>(Lbf/d0;)V
    ...
    invoke-direct {v2, v3, v0}, Lge/l;-><init>(ILkotlin/coroutines/Continuation;)V

    invoke-virtual {v2}, Lge/l;->v()V

    invoke-virtual {v4, p3}, Lbf/e0;->b(Lbf/h0;)Lff/j;

    move-result-object p3

    new-instance v0, Lcom/unity3d/services/core/network/core/OkHttp3Client$execute$2$1;

    invoke-direct {v0, p3}, Lcom/unity3d/services/core/network/core/OkHttp3Client$execute$2$1;-><init>(Lbf/k;)V

    invoke-virtual {v2, v0}, Lge/l;->o(Lkotlin/jvm/functions/Function1;)V

    new-instance v0, Lcom/unity3d/services/core/network/core/OkHttp3Client$execute$2$2;

    invoke-direct {v0, v2, p2}, Lcom/unity3d/services/core/network/core/OkHttp3Client$execute$2$2;-><init>(Lkotlinx/coroutines/CancellableContinuation;Z)V

    invoke-virtual {p3, v0}, Lff/j;->c(Lbf/l;)V
