...
.field public final j:Lio/sentry/protocol/v;
...
.method public constructor <init>(Lio/sentry/protocol/v;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lio/sentry/protocol/v;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lio/sentry/i7;->a:Lio/sentry/protocol/v;

    iput-object p2, p0, Lio/sentry/i7;->b:Ljava/lang/String;

    iput-object p3, p0, Lio/sentry/i7;->c:Ljava/lang/String;

    iput-object p4, p0, Lio/sentry/i7;->d:Ljava/lang/String;

    iput-object p5, p0, Lio/sentry/i7;->e:Ljava/lang/String;

    iput-object p6, p0, Lio/sentry/i7;->f:Ljava/lang/String;

    iput-object p7, p0, Lio/sentry/i7;->g:Ljava/lang/String;

    iput-object p8, p0, Lio/sentry/i7;->i:Ljava/lang/String;

    iput-object p9, p0, Lio/sentry/i7;->j:Lio/sentry/protocol/v;

    iput-object p10, p0, Lio/sentry/i7;->h:Ljava/lang/String;
...
.method public final serialize(Lio/sentry/k3;Lio/sentry/ILogger;)V
    ...
    iget-object v0, p0, Lio/sentry/i7;->a:Lio/sentry/protocol/v;
    ...
    iget-object v0, p0, Lio/sentry/i7;->b:Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/sentry/i7;->c:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lio/sentry/i7;->d:Ljava/lang/String;
    ...
    :cond_1
    iget-object v0, p0, Lio/sentry/i7;->e:Ljava/lang/String;
    ...
    :cond_2
    iget-object v0, p0, Lio/sentry/i7;->f:Ljava/lang/String;
    ...
    :cond_3
    iget-object v0, p0, Lio/sentry/i7;->g:Ljava/lang/String;
    ...
    :cond_4
    iget-object v0, p0, Lio/sentry/i7;->h:Ljava/lang/String;
    ...
    :cond_5
    iget-object v0, p0, Lio/sentry/i7;->i:Ljava/lang/String;
    ...
    :cond_6
    iget-object v0, p0, Lio/sentry/i7;->j:Lio/sentry/protocol/v;
    ...
    :cond_7
    iget-object v0, p0, Lio/sentry/i7;->k:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v2, p0, Lio/sentry/i7;->k:Ljava/util/concurrent/ConcurrentHashMap;
