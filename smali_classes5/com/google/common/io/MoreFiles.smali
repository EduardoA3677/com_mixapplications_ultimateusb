...
# direct methods
.method public static a(Ljava/nio/file/DirectoryStream;)Ljava/util/Collection;
    .locals 2
    ...
    invoke-static {v1}, Lcom/applovin/impl/l9;->d(Ljava/lang/Object;)Ljava/nio/file/Path;

    move-result-object v1

    invoke-static {v1}, Lcom/google/common/io/MoreFiles;->c(Ljava/nio/file/Path;)Ljava/util/Collection;
...
.method public static varargs asByteSink(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Lcom/google/common/io/ByteSink;
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/common/io/MoreFiles$PathByteSink;-><init>(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)V
...
.method public static varargs asByteSource(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)Lcom/google/common/io/ByteSource;
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/common/io/MoreFiles$PathByteSource;-><init>(Ljava/nio/file/Path;[Ljava/nio/file/OpenOption;)V
...
.method public static b(Ljava/nio/file/SecureDirectoryStream;)Ljava/util/Collection;
    .locals 3
    ...
    invoke-static {v2}, Lcom/applovin/impl/l9;->d(Ljava/lang/Object;)Ljava/nio/file/Path;
    ...
    invoke-static {p0, v2}, Lcom/google/common/io/MoreFiles;->d(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;)Ljava/util/Collection;
...
.method public static c(Ljava/nio/file/Path;)Ljava/util/Collection;
    .locals 4
    ...
    :try_start_1
    invoke-static {v0}, Lcom/google/common/io/MoreFiles;->a(Ljava/nio/file/DirectoryStream;)Ljava/util/Collection;
...
.method public static d(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;)Ljava/util/Collection;
    .locals 6
    ...
    const-class v5, Ljava/nio/file/attribute/BasicFileAttributeView;

    invoke-interface {p0, p1, v5, v2}, Ljava/nio/file/SecureDirectoryStream;->getFileAttributeView(Ljava/lang/Object;Ljava/lang/Class;[Ljava/nio/file/LinkOption;)Ljava/nio/file/attribute/FileAttributeView;
    ...
    :try_start_1
    invoke-static {v0}, Lcom/google/common/io/MoreFiles;->b(Ljava/nio/file/SecureDirectoryStream;)Ljava/util/Collection;
...
.method public static varargs deleteDirectoryContents(Ljava/nio/file/Path;[Lcom/google/common/io/RecursiveDeleteOption;)V
    ...
    :try_start_1
    invoke-static {v1}, Lcom/google/common/io/e;->b(Ljava/lang/Object;)Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-static {v1}, Lcom/google/common/io/e;->a(Ljava/lang/Object;)Ljava/nio/file/SecureDirectoryStream;

    move-result-object p1

    invoke-static {p1}, Lcom/google/common/io/MoreFiles;->b(Ljava/nio/file/SecureDirectoryStream;)Ljava/util/Collection;
    ...
    invoke-static {v1}, Lcom/google/common/io/MoreFiles;->a(Ljava/nio/file/DirectoryStream;)Ljava/util/Collection;
    ...
    invoke-direct {p1, v2}, Lcom/google/common/io/InsecureRecursiveDeleteException;-><init>(Ljava/lang/String;)V
    ...
    :cond_4
    invoke-static {p0, p1}, Lcom/google/common/io/MoreFiles;->e(Ljava/nio/file/Path;Ljava/util/Collection;)V
...
.method public static varargs deleteRecursively(Ljava/nio/file/Path;[Lcom/google/common/io/RecursiveDeleteOption;)V
    ...
    :try_start_1
    invoke-static {v0}, Lcom/google/common/io/e;->b(Ljava/lang/Object;)Z

    move-result v3

    if-eqz v3, :cond_2

    invoke-static {v0}, Lcom/google/common/io/e;->a(Ljava/lang/Object;)Ljava/nio/file/SecureDirectoryStream;
    ...
    invoke-static {v1, v3}, Lcom/google/common/io/MoreFiles;->d(Ljava/nio/file/SecureDirectoryStream;Ljava/nio/file/Path;)Ljava/util/Collection;
    ...
    invoke-static {p0}, Lcom/google/common/io/MoreFiles;->c(Ljava/nio/file/Path;)Ljava/util/Collection;
    ...
    invoke-direct {p1, v0}, Lcom/google/common/io/InsecureRecursiveDeleteException;-><init>(Ljava/lang/String;)V
    ...
    :cond_7
    invoke-static {p0, v3}, Lcom/google/common/io/MoreFiles;->e(Ljava/nio/file/Path;Ljava/util/Collection;)V
...
.method public static e(Ljava/nio/file/Path;Ljava/util/Collection;)V
    .locals 6
    ...
    :cond_2
    check-cast v0, Ljava/nio/file/NoSuchFileException;

    invoke-virtual {v0}, Ljava/nio/file/NoSuchFileException;->getFile()Ljava/lang/String;
    ...
    invoke-virtual {v3, v5, v4}, Ljava/nio/file/FileSystem;->getPath(Ljava/lang/String;[Ljava/lang/String;)Ljava/nio/file/Path;
