.class public final Lorg/bidon/amazon/impl/e;
...
# instance fields
.field public final synthetic a:Lorg/bidon/amazon/impl/f;

.field public final synthetic b:Lorg/bidon/amazon/impl/h;


# direct methods
.method public constructor <init>(Lorg/bidon/amazon/impl/f;Lorg/bidon/amazon/impl/h;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lorg/bidon/amazon/impl/e;->a:Lorg/bidon/amazon/impl/f;

    iput-object p2, p0, Lorg/bidon/amazon/impl/e;->b:Lorg/bidon/amazon/impl/h;
...
.method public final onAdClicked(Landroid/view/View;)V
    ...
    const-string p1, "AmazonRewardedImpl"
    ...
    iget-object v0, p0, Lorg/bidon/amazon/impl/e;->a:Lorg/bidon/amazon/impl/f;

    iget-object v1, v0, Lorg/bidon/amazon/impl/f;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
    ...
    invoke-virtual {v0, p1}, Lorg/bidon/amazon/impl/f;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
...
.method public final onAdClosed(Landroid/view/View;)V
    ...
    iget-object p1, p0, Lorg/bidon/amazon/impl/e;->a:Lorg/bidon/amazon/impl/f;

    iget-object v0, p1, Lorg/bidon/amazon/impl/f;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
    ...
    invoke-direct {v2, v0, v1}, Lorg/bidon/sdk/adapter/AdEvent$OnReward;-><init>(Lorg/bidon/sdk/ads/Ad;Lorg/bidon/sdk/ads/rewarded/Reward;)V

    invoke-virtual {p1, v2}, Lorg/bidon/amazon/impl/f;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
    ...
    :cond_0
    iput-object v1, p1, Lorg/bidon/amazon/impl/f;->d:Lcom/amazon/device/ads/DTBAdInterstitial;
...
.method public final onAdFailed(Landroid/view/View;)V
    ...
    iget-object v1, p0, Lorg/bidon/amazon/impl/e;->a:Lorg/bidon/amazon/impl/f;

    iget-object v2, v1, Lorg/bidon/amazon/impl/f;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
    ...
    invoke-virtual {v1, p1}, Lorg/bidon/amazon/impl/f;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
...
.method public final onImpressionFired(Landroid/view/View;)V
    ...
    invoke-virtual {p1, v1}, Lorg/bidon/amazon/impl/f;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V

    new-instance v1, Lorg/bidon/sdk/adapter/AdEvent$PaidRevenue;

    new-instance v2, Lorg/bidon/sdk/logs/analytic/AdValue;

    iget-object v3, p0, Lorg/bidon/amazon/impl/e;->b:Lorg/bidon/amazon/impl/h;
