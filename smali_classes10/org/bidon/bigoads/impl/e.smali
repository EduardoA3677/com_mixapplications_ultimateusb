.class public final Lorg/bidon/bigoads/impl/e;
...
# instance fields
.field public final synthetic a:Lorg/bidon/bigoads/impl/f;

.field public final synthetic b:Lorg/bidon/bigoads/impl/b;


# direct methods
.method public constructor <init>(Lorg/bidon/bigoads/impl/f;Lorg/bidon/bigoads/impl/b;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lorg/bidon/bigoads/impl/e;->a:Lorg/bidon/bigoads/impl/f;

    iput-object p2, p0, Lorg/bidon/bigoads/impl/e;->b:Lorg/bidon/bigoads/impl/b;
...
.method public final onAdLoaded(Lsg/bigo/ads/api/Ad;)V
    ...
    const-string v1, "BigoAdsBanner"

    invoke-static {v1, v0}, Lorg/bidon/sdk/logs/logging/impl/LogExtKt;->logInfo(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lorg/bidon/bigoads/impl/e;->a:Lorg/bidon/bigoads/impl/f;

    iput-object p1, v0, Lorg/bidon/bigoads/impl/f;->c:Lsg/bigo/ads/api/BannerAd;

    new-instance v1, Lorg/bidon/bigoads/impl/d;

    iget-object v2, p0, Lorg/bidon/bigoads/impl/e;->b:Lorg/bidon/bigoads/impl/b;

    invoke-direct {v1, v0, v2}, Lorg/bidon/bigoads/impl/d;-><init>(Lorg/bidon/bigoads/impl/f;Lorg/bidon/bigoads/impl/b;)V

    invoke-interface {p1, v1}, Lsg/bigo/ads/api/Ad;->setAdInteractionListener(Lsg/bigo/ads/api/AdInteractionListener;)V

    iget-object p1, v0, Lorg/bidon/bigoads/impl/f;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
    ...
    invoke-virtual {v0, v1}, Lorg/bidon/bigoads/impl/f;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
...
.method public final onError(Lsg/bigo/ads/api/AdError;)V
    ...
    invoke-virtual {v0, p1}, Lorg/bidon/bigoads/impl/f;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
