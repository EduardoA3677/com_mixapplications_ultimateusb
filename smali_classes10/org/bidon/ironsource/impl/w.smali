.class public final Lorg/bidon/ironsource/impl/w;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bidon/ironsource/impl/w;->a:Lorg/bidon/sdk/adapter/impl/AdEventFlowImpl;
    ...
    iput-object v0, p0, Lorg/bidon/ironsource/impl/w;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
...
.method public final addAuctionConfigurationId(J)V
    ...
    iget-object v0, p0, Lorg/bidon/ironsource/impl/w;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
...
.method public final destroy()V
    ...
    iput-object v0, p0, Lorg/bidon/ironsource/impl/w;->c:Ljava/lang/String;

    iget-object v1, p0, Lorg/bidon/ironsource/impl/w;->d:Lge/r1;

    if-eqz v1, :cond_0

    invoke-virtual {v1, v0}, Lge/j1;->cancel(Ljava/util/concurrent/CancellationException;)V

    :cond_0
    iput-object v0, p0, Lorg/bidon/ironsource/impl/w;->d:Lge/r1;
...
.method public final emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
    ...
    iget-object v0, p0, Lorg/bidon/ironsource/impl/w;->a:Lorg/bidon/sdk/adapter/impl/AdEventFlowImpl;
...
.method public final isAdReadyToShow()Z
    ...
    iget-object v0, p0, Lorg/bidon/ironsource/impl/w;->c:Ljava/lang/String;
...
.method public final load(Lorg/bidon/sdk/adapter/AdAuctionParams;)V
    ...
    check-cast p1, Lorg/bidon/ironsource/impl/o;

    const-string v0, "adParams"

    invoke-static {p1, v0}, Lkotlin/jvm/internal/p;->f(Ljava/lang/Object;Ljava/lang/String;)V

    iget-object v0, p1, Lorg/bidon/ironsource/impl/o;->d:Ljava/lang/String;

    iput-object v0, p0, Lorg/bidon/ironsource/impl/w;->c:Ljava/lang/String;

    iget-object v1, p0, Lorg/bidon/ironsource/impl/w;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
    ...
    invoke-virtual {p0, p1}, Lorg/bidon/ironsource/impl/w;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
    ...
    const-string v4, "IronSourceRewardedAdImpl"
    ...
    invoke-static {v4, p1}, Lorg/bidon/sdk/logs/logging/impl/LogExtKt;->logInfo(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lorg/bidon/ironsource/impl/w;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
    ...
    invoke-static {v4, v1}, Lorg/bidon/sdk/logs/logging/impl/LogExtKt;->logInfo(Ljava/lang/String;Ljava/lang/String;)V

    sget-object v1, Lorg/bidon/ironsource/impl/z;->a:Lgd/o;
    ...
    invoke-virtual {v1}, Lorg/bidon/ironsource/impl/y;->a()Lkotlinx/coroutines/flow/MutableSharedFlow;

    move-result-object v1

    new-instance v2, Lorg/bidon/ironsource/impl/r;

    const/4 v3, 0x1

    invoke-direct {v2, v1, v0, v3}, Lorg/bidon/ironsource/impl/r;-><init>(Lkotlinx/coroutines/flow/MutableSharedFlow;Ljava/lang/String;I)V

    new-instance v1, Lorg/bidon/ironsource/impl/v;

    const/4 v3, 0x0

    invoke-direct {v1, p0, v0, p1, v3}, Lorg/bidon/ironsource/impl/v;-><init>(Lorg/bidon/ironsource/impl/w;Ljava/lang/String;Lorg/bidon/ironsource/impl/o;Lkotlin/coroutines/Continuation;)V

    new-instance v3, Lcom/moloco/sdk/xenoss/sdkdevkit/android/adrenderer/internal/vast/render/ad/j;

    const/4 v4, 0x2

    invoke-direct {v3, v2, v1, v4}, Lcom/moloco/sdk/xenoss/sdkdevkit/android/adrenderer/internal/vast/render/ad/j;-><init>(Lkotlinx/coroutines/flow/Flow;Ljava/lang/Object;I)V
    ...
    invoke-static {v3, v1}, Lje/m;->x(Lkotlinx/coroutines/flow/Flow;Lkotlinx/coroutines/CoroutineScope;)Lge/r1;

    move-result-object v1

    iput-object v1, p0, Lorg/bidon/ironsource/impl/w;->d:Lge/r1;

    iget-object p1, p1, Lorg/bidon/ironsource/impl/o;->a:Landroid/app/Activity;
...
.method public final show(Landroid/app/Activity;)V
    ...
    invoke-virtual {p0}, Lorg/bidon/ironsource/impl/w;->isAdReadyToShow()Z

    move-result p1

    if-eqz p1, :cond_0

    iget-object p1, p0, Lorg/bidon/ironsource/impl/w;->c:Ljava/lang/String;
