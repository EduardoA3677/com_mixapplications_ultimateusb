...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/ironsource/O6;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lcom/ironsource/O6;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lcom/ironsource/O6;->a:Lcom/ironsource/y7;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/ironsource/O6;->b:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public synthetic constructor <init>(I)V
    ...
    invoke-direct {p0}, Lcom/ironsource/O6;-><init>()V

    return-void
.end method

.method public static bridge synthetic a(Lcom/ironsource/O6;)Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 0

    iget-object p0, p0, Lcom/ironsource/O6;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private a()V
    ...
    invoke-virtual {p0, v0}, Lcom/ironsource/O6;->a(Ljava/util/Map;)V
...
.method private a(Landroid/content/Context;)V
    ...
    iget-object v0, p0, Lcom/ironsource/O6;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v1, p0, p1}, Lcom/ironsource/O6$a;-><init>(Lcom/ironsource/O6;Landroid/content/Context;)V
    ...
    iget-object p1, p0, Lcom/ironsource/O6;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lcom/ironsource/O6;->b:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static b()Lcom/ironsource/O6;
    .locals 1

    sget-object v0, Lcom/ironsource/O6$b;->a:Lcom/ironsource/O6;

    return-object v0
.end method

.method public static bridge synthetic b(Lcom/ironsource/O6;Landroid/content/Context;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/ironsource/O6;->e(Landroid/content/Context;)V
...
.method private d(Landroid/content/Context;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/ironsource/O6;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_1
    iget-object v0, p0, Lcom/ironsource/O6;->a:Lcom/ironsource/y7;
    ...
    invoke-direct {p0, v1, v0}, Lcom/ironsource/O6;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-direct {p0, v2, v1}, Lcom/ironsource/O6;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p1}, Lcom/ironsource/y7;->r(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-interface {v0, p1}, Lcom/ironsource/y7;->q(Landroid/content/Context;)J
    ...
    invoke-direct {p0, v0, v1}, Lcom/ironsource/O6;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {p1}, Lcom/ironsource/Yc;->d(Landroid/content/Context;)Ljava/lang/Integer;
    ...
    invoke-direct {p0, v0, p1}, Lcom/ironsource/O6;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-direct {p0}, Lcom/ironsource/O6;->a()V
...
.method private f(Landroid/content/Context;)V
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/ironsource/O6;->a(Landroid/content/Context;)V
    ...
    invoke-direct {p0, v2, v0}, Lcom/ironsource/O6;->a(Ljava/lang/String;Ljava/lang/Object;)V

    goto :goto_0

    :cond_1
    invoke-direct {p0, v2}, Lcom/ironsource/O6;->a(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {p0, v2}, Lcom/ironsource/O6;->b(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1}, Lcom/ironsource/y7;->s(Landroid/content/Context;)I
    ...
    invoke-interface {v0, p1}, Lcom/ironsource/y7;->F(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-interface {v0, p1}, Lcom/ironsource/y7;->E(Landroid/content/Context;)F
    ...
    invoke-interface {v0, p1}, Lcom/ironsource/y7;->C(Landroid/content/Context;)Z
    ...
    invoke-interface {v0, p1}, Lcom/ironsource/y7;->D(Landroid/content/Context;)I
    ...
    invoke-interface {v0, p1}, Lcom/ironsource/y7;->e(Landroid/content/Context;)Z
    ...
    invoke-interface {v0, p1}, Lcom/ironsource/y7;->h(Landroid/content/Context;)Z
    ...
    invoke-interface {v0, p1}, Lcom/ironsource/y7;->k(Landroid/content/Context;)I
    ...
    iget-object p1, p0, Lcom/ironsource/O6;->a:Lcom/ironsource/y7;
    ...
    invoke-direct {p0, p1, v0}, Lcom/ironsource/O6;->a(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public a(Ljava/lang/String;Lorg/json/JSONArray;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/ironsource/O6;->a(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public a(Ljava/util/Map;)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/ironsource/O6;->a(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public b(Landroid/content/Context;)Lorg/json/JSONObject;
    ...
    invoke-direct {p0, p1}, Lcom/ironsource/O6;->f(Landroid/content/Context;)V

    new-instance p1, Lorg/json/JSONObject;

    iget-object v0, p0, Lcom/ironsource/O6;->b:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-static {v0}, Lcom/ironsource/Q6;->a(Ljava/util/concurrent/ConcurrentHashMap;)Ljava/util/HashMap;
...
.method public c(Landroid/content/Context;)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, Lcom/ironsource/O6;->d(Landroid/content/Context;)V
