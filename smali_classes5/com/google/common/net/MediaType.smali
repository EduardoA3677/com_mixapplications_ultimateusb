...
.field public static final AVIF:Lcom/google/common/net/MediaType;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcom/google/common/net/MediaType;->AVIF:Lcom/google/common/net/MediaType;
...
.method public static parse(Ljava/lang/String;)Lcom/google/common/net/MediaType;
    ...
    sget-object v0, Lcom/google/common/net/MediaType;->j:Lcom/google/common/base/CharMatcher;

    sget-object v1, Lcom/google/common/net/MediaType;->h:Lcom/google/common/base/CharMatcher;

    invoke-static {p0}, Lcom/google/common/base/Preconditions;->checkNotNull(Ljava/lang/Object;)Ljava/lang/Object;

    new-instance v2, Lcom/google/common/net/MediaType$Tokenizer;

    invoke-direct {v2, p0}, Lcom/google/common/net/MediaType$Tokenizer;-><init>(Ljava/lang/String;)V

    :try_start_0
    invoke-virtual {v2, v1}, Lcom/google/common/net/MediaType$Tokenizer;->b(Lcom/google/common/base/CharMatcher;)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v0}, Lcom/google/common/net/MediaType$Tokenizer;->c(Lcom/google/common/base/CharMatcher;)Ljava/lang/String;

    const/16 v4, 0x2f

    invoke-virtual {v2, v4}, Lcom/google/common/net/MediaType$Tokenizer;->a(C)V
    ...
    :goto_0
    invoke-virtual {v2}, Lcom/google/common/net/MediaType$Tokenizer;->d()Z
    ...
    invoke-virtual {v2, v6}, Lcom/google/common/net/MediaType$Tokenizer;->a(C)V
    ...
    invoke-virtual {v2, v7}, Lcom/google/common/net/MediaType$Tokenizer;->a(C)V

    invoke-virtual {v2, v0}, Lcom/google/common/net/MediaType$Tokenizer;->c(Lcom/google/common/base/CharMatcher;)Ljava/lang/String;

    invoke-virtual {v2}, Lcom/google/common/net/MediaType$Tokenizer;->e()C
    ...
    invoke-virtual {v2, v8}, Lcom/google/common/net/MediaType$Tokenizer;->a(C)V
    ...
    invoke-virtual {v2, v10}, Lcom/google/common/net/MediaType$Tokenizer;->a(C)V
    ...
    invoke-virtual {v9, v10}, Lcom/google/common/base/CharMatcher;->matches(C)Z

    move-result v9

    invoke-static {v9}, Lcom/google/common/base/Preconditions;->checkState(Z)V

    iget v9, v2, Lcom/google/common/net/MediaType$Tokenizer;->b:I

    add-int/lit8 v9, v9, 0x1

    iput v9, v2, Lcom/google/common/net/MediaType$Tokenizer;->b:I
    ...
    :cond_0
    sget-object v9, Lcom/google/common/net/MediaType;->i:Lcom/google/common/base/CharMatcher;

    invoke-virtual {v2, v9}, Lcom/google/common/net/MediaType$Tokenizer;->b(Lcom/google/common/base/CharMatcher;)Ljava/lang/String;
    ...
    :goto_2
    invoke-virtual {v5, v6, v7}, Lcom/google/common/collect/ImmutableListMultimap$Builder;->put(Ljava/lang/Object;Ljava/lang/Object;)Lcom/google/common/collect/ImmutableListMultimap$Builder;
    ...
    invoke-static {v3, v4, v0}, Lcom/google/common/net/MediaType;->a(Ljava/lang/String;Ljava/lang/String;Lcom/google/common/collect/Multimap;)Lcom/google/common/net/MediaType;
...
.method public charset()Lcom/google/common/base/Optional;
    ...
    invoke-static {v1, v2, v4, v3}, Landroidx/constraintlayout/core/dsl/a;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-static {p1, v1}, Lcom/google/common/collect/Maps;->transformValues(Ljava/util/Map;Lcom/google/common/base/Function;)Ljava/util/Map;
...
.method public withParameters(Ljava/lang/String;Ljava/lang/Iterable;)Lcom/google/common/net/MediaType;
    ...
    invoke-direct {p2, v3, v1, v0}, Lcom/google/common/net/MediaType;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/google/common/collect/ImmutableListMultimap;)V
