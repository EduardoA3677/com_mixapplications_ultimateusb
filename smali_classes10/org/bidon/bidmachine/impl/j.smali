.class public final Lorg/bidon/bidmachine/impl/j;
...
# instance fields
.field public final synthetic a:Lorg/bidon/bidmachine/impl/l;

.field public final synthetic b:Lorg/bidon/sdk/stats/models/BidType;


# direct methods
.method public constructor <init>(Lorg/bidon/bidmachine/impl/l;Lorg/bidon/sdk/stats/models/BidType;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lorg/bidon/bidmachine/impl/j;->a:Lorg/bidon/bidmachine/impl/l;

    iput-object p2, p0, Lorg/bidon/bidmachine/impl/j;->b:Lorg/bidon/sdk/stats/models/BidType;
...
.method public final onAdClicked(Lio/bidmachine/IAd;)V
    ...
    const-string v0, "BidMachineRewarded"

    invoke-static {v0, p1}, Lorg/bidon/sdk/logs/logging/impl/LogExtKt;->logInfo(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p1, p0, Lorg/bidon/bidmachine/impl/j;->a:Lorg/bidon/bidmachine/impl/l;

    iget-object v0, p1, Lorg/bidon/bidmachine/impl/l;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
    ...
    invoke-virtual {p1, v1}, Lorg/bidon/bidmachine/impl/l;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
...
.method public final onAdClosed(Lio/bidmachine/IAd;Z)V
    ...
    const-string p2, "BidMachineRewarded"

    invoke-static {p2, p1}, Lorg/bidon/sdk/logs/logging/impl/LogExtKt;->logInfo(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p1, p0, Lorg/bidon/bidmachine/impl/j;->a:Lorg/bidon/bidmachine/impl/l;

    iget-object p2, p1, Lorg/bidon/bidmachine/impl/l;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
    ...
    invoke-virtual {p1, v0}, Lorg/bidon/bidmachine/impl/l;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V

    :cond_0
    const/4 p2, 0x0

    iput-object p2, p1, Lorg/bidon/bidmachine/impl/l;->f:Lib/a;

    iput-object p2, p1, Lorg/bidon/bidmachine/impl/l;->e:Lib/e;
...
.method public final onAdImpression(Lio/bidmachine/IAd;)V
    ...
    const-string v1, "BidMachineRewarded"

    invoke-static {v1, v0}, Lorg/bidon/sdk/logs/logging/impl/LogExtKt;->logInfo(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lorg/bidon/bidmachine/impl/j;->a:Lorg/bidon/bidmachine/impl/l;

    iget-object v1, v0, Lorg/bidon/bidmachine/impl/l;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
    ...
    invoke-virtual {v0, v2}, Lorg/bidon/bidmachine/impl/l;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
...
.method public final onAdLoaded(Lio/bidmachine/IAd;)V
    ...
    :goto_0
    iget-object v1, p0, Lorg/bidon/bidmachine/impl/j;->a:Lorg/bidon/bidmachine/impl/l;

    invoke-virtual {v1, v0}, Lorg/bidon/bidmachine/impl/l;->setDsp(Ljava/lang/String;)V

    iget-object v0, p0, Lorg/bidon/bidmachine/impl/j;->b:Lorg/bidon/sdk/stats/models/BidType;
    ...
    :goto_1
    invoke-virtual {v1, v2, v3}, Lorg/bidon/bidmachine/impl/l;->setPrice(D)V

    :cond_2
    iget-object p1, v1, Lorg/bidon/bidmachine/impl/l;->b:Lorg/bidon/sdk/stats/impl/StatisticsCollectorImpl;
    ...
    invoke-virtual {v1, v0}, Lorg/bidon/bidmachine/impl/l;->emitEvent(Lorg/bidon/sdk/adapter/AdEvent;)V
