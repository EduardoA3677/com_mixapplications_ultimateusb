...
.method public static final formatStackTrace([Ljava/lang/StackTraceElement;)Ljava/lang/String;
    ...
    sget-object v5, Lcom/mobilefuse/sdk/telemetry/TelemetryHelpersKt$formatStackTrace$1;->INSTANCE:Lcom/mobilefuse/sdk/telemetry/TelemetryHelpersKt$formatStackTrace$1;
...
.method public static final getLastActionWithParamOrNull(Lcom/mobilefuse/sdk/telemetry/TelemetryActionReceiver;Lcom/mobilefuse/sdk/telemetry/TelemetryParamType;)Lcom/mobilefuse/sdk/telemetry/TelemetryAction;
    ...
    invoke-static {p0}, Lhd/t;->H0(Ljava/util/List;)Lde/g;

    move-result-object p0

    invoke-virtual {p0}, Lde/g;->iterator()Ljava/util/Iterator;
    ...
    iget-object v0, v0, Lhd/l0;->a:Ljava/util/ListIterator;
...
.method public static final getLogs(Lcom/mobilefuse/sdk/telemetry/TelemetryAction;)Ljava/lang/String;
    ...
    check-cast v4, Lcom/mobilefuse/sdk/telemetry/TelemetryActionParam;

    invoke-virtual {v4}, Lcom/mobilefuse/sdk/telemetry/TelemetryActionParam;->getType()Lcom/mobilefuse/sdk/telemetry/TelemetryParamType;

    move-result-object v5

    invoke-interface {v5}, Lcom/mobilefuse/sdk/telemetry/TelemetryParamType;->getPrintInLogs()Z
    ...
    invoke-static {v5}, Lcom/mobilefuse/sdk/telemetry/TelemetryHelpersKt;->getEscapedName(Lcom/mobilefuse/sdk/telemetry/TelemetryParamType;)Ljava/lang/String;
    ...
    invoke-static {v0, v5, v7, v7, v6}, Lde/k;->q0(Ljava/lang/CharSequence;Ljava/lang/String;IZI)I
    ...
    invoke-interface {v5}, Lcom/mobilefuse/sdk/telemetry/TelemetryActionType;->getIncludeImplicitParamsInLogs()Z
    ...
    invoke-static {v3, v5}, Lab/a;->y(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {v5}, Lcom/mobilefuse/sdk/telemetry/TelemetryParamType;->getValue()Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/mobilefuse/sdk/telemetry/TelemetryHelpersKt;->getBeautifyValue(Lcom/mobilefuse/sdk/telemetry/TelemetryActionParam;)Ljava/lang/Object;
    ...
    invoke-static {v0, v5, v4, v7}, Lde/r;->Y(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {v4, p0, v0, v1, v0}, Lo3/m3;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/regex/Matcher;
...
.method public static final getTelemetryAction(Ljava/lang/Throwable;)Lcom/mobilefuse/sdk/telemetry/TelemetryAction;
    ...
    filled-new-array {v1}, [Lcom/mobilefuse/sdk/telemetry/TelemetryActionParam;

    move-result-object p0

    invoke-static {p0}, Llf/l;->S([Ljava/lang/Object;)Ljava/util/ArrayList;
...
.method public static final sanitizeVersionNames(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v1, v4, v3}, Lde/r;->c0(Ljava/lang/String;Ljava/lang/String;Z)Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-static {v1, v4}, Lde/k;->y0(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
