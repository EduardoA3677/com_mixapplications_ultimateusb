...
# direct methods
.method public static a([Ljava/util/stream/BaseStream;)V
    .locals 4
...
.method public static varargs concat([Ljava/util/stream/DoubleStream;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v4}, Ljava/util/stream/BaseStream;->isParallel()Z

    move-result v5

    or-int/2addr v3, v5

    invoke-interface {v4}, Ljava/util/stream/DoubleStream;->spliterator()Ljava/util/Spliterator$OfDouble;

    move-result-object v4

    invoke-virtual {v0, v4}, Lcom/google/common/collect/ImmutableList$Builder;->add(Ljava/lang/Object;)Lcom/google/common/collect/ImmutableList$Builder;

    invoke-interface {v4}, Ljava/util/Spliterator;->characteristics()I
    ...
    invoke-static {v9, v10, v4, v5}, Lcom/google/common/math/LongMath;->saturatedAdd(JJ)J
    ...
    invoke-direct {v7, v0}, Lcom/google/common/collect/d;-><init>(I)V
    ...
    new-instance v4, Lcom/google/common/collect/CollectSpliterators$FlatMapSpliteratorOfDouble;

    const/4 v5, 0x0

    invoke-direct/range {v4 .. v10}, Lcom/google/common/collect/CollectSpliterators$FlatMapSpliteratorOfDouble;-><init>(Ljava/util/Spliterator$OfDouble;Ljava/util/Spliterator;Ljava/util/function/Function;IJ)V

    invoke-static {v4, v3}, Ljava/util/stream/StreamSupport;->doubleStream(Ljava/util/Spliterator$OfDouble;Z)Ljava/util/stream/DoubleStream;
    ...
    invoke-direct {v1, p0, v2}, Lcom/google/common/collect/y;-><init>(Ljava/lang/Object;I)V
...
.method public static varargs concat([Ljava/util/stream/IntStream;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v4}, Ljava/util/stream/IntStream;->spliterator()Ljava/util/Spliterator$OfInt;
    ...
    new-instance v7, Lcom/google/common/collect/b0;

    const/4 v0, 0x1

    invoke-direct {v7, v0}, Lcom/google/common/collect/b0;-><init>(I)V
    ...
    new-instance v4, Lcom/google/common/collect/CollectSpliterators$FlatMapSpliteratorOfInt;

    const/4 v5, 0x0

    invoke-direct/range {v4 .. v10}, Lcom/google/common/collect/CollectSpliterators$FlatMapSpliteratorOfInt;-><init>(Ljava/util/Spliterator$OfInt;Ljava/util/Spliterator;Ljava/util/function/Function;IJ)V

    invoke-static {v4, v3}, Ljava/util/stream/StreamSupport;->intStream(Ljava/util/Spliterator$OfInt;Z)Ljava/util/stream/IntStream;
...
.method public static varargs concat([Ljava/util/stream/LongStream;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v4}, Ljava/util/stream/LongStream;->spliterator()Ljava/util/Spliterator$OfLong;
    ...
    new-instance v4, Lcom/google/common/collect/CollectSpliterators$FlatMapSpliteratorOfLong;

    const/4 v5, 0x0

    invoke-direct/range {v4 .. v10}, Lcom/google/common/collect/CollectSpliterators$FlatMapSpliteratorOfLong;-><init>(Ljava/util/Spliterator$OfLong;Ljava/util/Spliterator;Ljava/util/function/Function;IJ)V

    invoke-static {v4, v3}, Ljava/util/stream/StreamSupport;->longStream(Ljava/util/Spliterator$OfLong;Z)Ljava/util/stream/LongStream;
...
.method public static varargs concat([Ljava/util/stream/Stream;)Ljava/util/stream/Stream;
    ...
    invoke-interface {v4}, Ljava/util/stream/BaseStream;->spliterator()Ljava/util/Spliterator;
    ...
    new-instance v4, Lcom/google/common/collect/CollectSpliterators$FlatMapSpliteratorOfObject;

    const/4 v5, 0x0

    invoke-direct/range {v4 .. v10}, Lcom/google/common/collect/CollectSpliterators$FlatMapSpliteratorOfObject;-><init>(Ljava/util/Spliterator;Ljava/util/Spliterator;Ljava/util/function/Function;IJ)V

    invoke-static {v4, v3}, Ljava/util/stream/StreamSupport;->stream(Ljava/util/Spliterator;Z)Ljava/util/stream/Stream;
...
.method public static findLast(Ljava/util/stream/Stream;)Ljava/util/Optional;
    ...
    iput-object v1, v0, Lcom/google/common/collect/Streams$1OptionalState;->b:Ljava/lang/Object;
    ...
    invoke-direct {v1, v0, v2}, Lcom/google/common/collect/m;-><init>(Ljava/lang/Object;I)V

    invoke-interface {p0, v1}, Ljava/util/Spliterator;->forEachRemaining(Ljava/util/function/Consumer;)V

    iget-object p0, v0, Lcom/google/common/collect/Streams$1OptionalState;->b:Ljava/lang/Object;
    ...
    invoke-direct {v2, v0, v3}, Lcom/google/common/collect/m;-><init>(Ljava/lang/Object;I)V

    invoke-interface {p0, v2}, Ljava/util/Spliterator;->forEachRemaining(Ljava/util/function/Consumer;)V

    iget-boolean p0, v0, Lcom/google/common/collect/Streams$1OptionalState;->a:Z
...
.method public static forEachPair(Ljava/util/stream/Stream;Ljava/util/stream/Stream;Ljava/util/function/BiConsumer;)V
    ...
    invoke-direct {p1, p2, v0}, Lcom/google/common/collect/m;-><init>(Ljava/lang/Object;I)V
...
.method public static mapWithIndex(Ljava/util/stream/DoubleStream;Lcom/google/common/collect/Streams$DoubleFunctionWithIndex;)Ljava/util/stream/Stream;
    ...
    invoke-direct {v0, p0, v1}, Lcom/google/common/collect/y;-><init>(Ljava/lang/Object;I)V
...
.method public static zip(Ljava/util/stream/Stream;Ljava/util/stream/Stream;Ljava/util/function/BiFunction;)Ljava/util/stream/Stream;
    ...
    invoke-direct {p2, p1, v0}, Lcom/google/common/collect/y;-><init>(Ljava/lang/Object;I)V
