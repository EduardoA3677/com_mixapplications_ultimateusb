...
# direct methods
.method public static Q(Ljava/io/File;Ljava/io/File;I)V
    .locals 1
    ...
    invoke-direct {p2, p0, p1, v0}, Lio/ktor/utils/io/p0;-><init>(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)V
    ...
    :try_start_1
    invoke-static {p2, p0, p1}, Lio/sentry/config/a;->A(Ljava/io/InputStream;Ljava/io/OutputStream;I)J
    :try_end_1
    ...
    invoke-direct {p1, p0, v0, p2}, Lio/ktor/utils/io/p0;-><init>(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)V
...
.method public static R(Ljava/io/File;)V
    ...
    sget-object v0, Lsd/h;->b:Lsd/h;

    new-instance v1, Lce/j;

    invoke-direct {v1, p0, v0}, Lce/j;-><init>(Ljava/io/File;Lsd/h;)V

    new-instance p0, Lsd/f;

    invoke-direct {p0, v1}, Lsd/f;-><init>(Lce/j;)V
...
.method public static T(Ljava/io/File;)[B
    ...
    invoke-static {v0, v6, v5}, Lio/sentry/config/a;->A(Ljava/io/InputStream;Ljava/io/OutputStream;I)J
    ...
    invoke-virtual {v6}, Lio/sentry/cache/tape/c;->n()[B
    ...
    invoke-static {v1, v3, v4, p0, v2}, Lhd/q;->R(III[B[B)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public static U(Ljava/io/File;)Ljava/util/ArrayList;
    .locals 5
    ...
    invoke-virtual {p0}, Lce/a;->iterator()Ljava/util/Iterator;
...
.method public static W(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p1, v1, v2, v3}, Lde/k;->p0(Ljava/lang/CharSequence;CII)I
    ...
    invoke-static {p1, v1, v4, v3}, Lde/k;->p0(Ljava/lang/CharSequence;CII)I
    ...
    invoke-static {p1, v3}, Lde/k;->k0(Ljava/lang/String;C)Z
    ...
    invoke-static {p0, v1}, Lde/k;->k0(Ljava/lang/String;C)Z
...
.method public static X(Ljava/io/File;Ljava/lang/String;Ljava/nio/charset/Charset;)V
    .locals 1
    ...
    :try_start_0
    invoke-static {v0, p1, p2}, Lsd/i;->Z(Ljava/io/FileOutputStream;Ljava/lang/String;Ljava/nio/charset/Charset;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static synthetic Y(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1, v0}, Lsd/i;->X(Ljava/io/File;Ljava/lang/String;Ljava/nio/charset/Charset;)V
